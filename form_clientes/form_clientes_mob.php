...
//
   ...
   $_SESSION['scriptcase']['form_clientes_mob']['glo_nm_perfil']          = "conexion_mysql";
          ...
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  if (isset($inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag) && $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag)
                  {
                      ...
                      $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['redir']['script_case_session']  = session_id();
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_clientes_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'pasaporte_beta2'); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_clientes_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_clientes_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['form_clientes_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'pasaporte_beta2', 1, true);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['form_clientes']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['form_clientes']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_pasaporte_beta2'])) {
                $_SESSION['scriptcase']['form_clientes']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pasaporte_beta2'];
            }
        }
    }
    ...
    {
        if ('ajax_form_clientes_mob_validate_cedula' == $_POST['rs'])
        {
            $cedula = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_clientes_mob_validate_nombre' == $_POST['rs'])
        {
        ...
        if ('ajax_form_clientes_mob_validate_movil' == $_POST['rs'])
        {
            $movil = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_clientes_mob_validate_ciudad' == $_POST['rs'])
        {
        ...
        if ('ajax_form_clientes_mob_submit_form' == $_POST['rs'])
        {
            ...
            $email = NM_utf8_urldecode($_POST['rsargs'][2]);
            $movil = NM_utf8_urldecode($_POST['rsargs'][3]);
            $ciudad = NM_utf8_urldecode($_POST['rsargs'][4]);
            $empresa = NM_utf8_urldecode($_POST['rsargs'][5]);
    ...
    else
    {
        ...
        elseif ($_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['run_iframe'] != "R")
        {
           ...
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            ...
            {
                $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['retorno_edit'] . "?script_case_init=" . $script_case_init . "&script_case_session=" . session_id();  
                $nm_apl_dependente = 1 ; 
                $nm_saida_global = $nm_url_saida;
            } 
        ...
        { 
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['retorno_edit'] = $nmgp_url_saida . "?script_case_init=" . $script_case_init . "&script_case_session=" . session_id(); 
            } 
        } 
...
<?php
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_form_clientes_mob_validate_cedula");
    sajax_export("ajax_form_clientes_mob_validate_nombre");
    sajax_export("ajax_form_clientes_mob_validate_email");
    sajax_export("ajax_form_clientes_mob_validate_movil");
    sajax_export("ajax_form_clientes_mob_validate_ciudad");
...
//
    ...
    function ajax_form_clientes_mob_validate_cedula($cedula, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        ...
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_cedula';
    ...
    function ajax_form_clientes_mob_validate_nombre($nombre, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_nombre';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_validate_movil($movil, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_movil';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
                  'movil' => NM_utf8_urldecode($movil),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param']['buffer_output'])
    ...
    function ajax_form_clientes_mob_validate_ciudad($ciudad, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_ciudad';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_submit_form($cedula, $nombre, $email, $movil, $ciudad, $empresa, $id, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
