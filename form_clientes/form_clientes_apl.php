...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['movil']))
          {
              $this->movil = $this->NM_ajax_info['param']['movil'];
          }
      ...
      $_SESSION['scriptcase']['error_icon']['form_clientes']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
//
      ...
      if (isset($this->movil)) { $this->nm_limpa_alfa($this->movil); }
   ...
   function loadFieldConfig()
   {
      ...
      //-- cedula
      $this->field_config['cedula']               = array();
      $this->field_config['cedula']['symbol_grp'] = '';
      $this->field_config['cedula']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['cedula']['symbol_dec'] = '';
      $this->field_config['cedula']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['cedula']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- id
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_movil' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'movil');
          }
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clientes', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_clientes', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_clientes', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ('' == $filtro || 'movil' == $filtro)
        $this->ValidateField_movil($Campos_Crit, $Campos_Falta, $Campos_Erros);
    ...
    function ValidateField_cedula(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      nm_limpa_numero($this->cedula, $this->field_config['cedula']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->cedula != '')  
          { 
              $iTestSize = 100;
              if (strlen($this->cedula) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Cedula: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['cedula']))
                  {
                      $Campos_Erros['cedula'] = array();
                  }
                  $Campos_Erros['cedula'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  ...
                  $this->NM_ajax_info['errList']['cedula'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->cedula, 100, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Cedula; " ; 
                  if (!isset($Campos_Erros['cedula']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['cedula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['cedula'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Cedula" ; 
              if (!isset($Campos_Erros['cedula']))
    ...
    function ValidateField_nombre(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['nombre'] == "on")) 
      { 
          if ($this->nombre == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['email'] == "on")) 
      { 
          if ($this->email == "")  
          { 
              $hasError = true;
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Email " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['email']))
              {
                  $Campos_Erros['email'] = array();
              }
    ...
    function ValidateField_movil(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->movil) > 20) 
          { 
              $hasError = true;
              $Campos_Crit .= "Movil " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['movil']))
              {
                  $Campos_Erros['movil'] = array();
              }
              $Campos_Erros['movil'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['movil']) || !is_array($this->NM_ajax_info['errList']['movil']))
              {
                  $this->NM_ajax_info['errList']['movil'] = array();
              }
              $this->NM_ajax_info['errList']['movil'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_empresa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->empresa) > 100) 
          { 
              $hasError = true;
              $Campos_Crit .= "Empresa " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['empresa']))
              {
                  $Campos_Erros['empresa'] = array();
              }
              $Campos_Erros['empresa'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['empresa'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['movil'] = $this->movil;
   ...
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['cedula'] = $this->cedula;
      nm_limpa_numero($this->cedula, $this->field_config['cedula']['symbol_grp']) ; 
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ('' !== $this->cedula || (!empty($format_fields) && isset($format_fields['cedula'])))
      {
          nmgp_Form_Num_Val($this->cedula, $this->field_config['cedula']['symbol_grp'], $this->field_config['cedula']['symbol_dec'], "0", "S", $this->field_config['cedula']['format_neg'], "", "", "-", $this->field_config['cedula']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values_email($bForce = false)
   {
          ...
          //----- movil
   function ajax_return_values_movil($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("movil", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->movil);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['movil'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['opcao'] = '';
   ...
   { 
      ...
      if ($this->cedula === "" || is_null($this->cedula))  
      { 
          $this->cedula = 0;
          $this->sc_force_zero[] = 'cedula';
      } 
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->movil_before_qstr = $this->movil;
          $this->movil = substr($this->Db->qstr($this->movil), 1, -1); 
          if ($this->movil == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->movil = "null"; 
              $NM_val_null[] = "movil";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $aUpdateOk = array();
              $Cmd_Unique = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where (cedula = " . $this->cedula . ") AND (id <> $this->id)";
              ...
              if (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_ukey'] . " Cedula"); 
                  $this->nmgp_opcao = "nada"; 
                  $aUpdateOk[] = 'cedula';
              }
              $rsUni->Close();
              $Cmd_Unique = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where (email = '" . $this->email . "') AND (id <> $this->id)";
              $Cmd_Unique = str_replace("'null'", "null", $Cmd_Unique) ; 
              $Cmd_Unique = str_replace("#null#", "null", $Cmd_Unique) ; 
              $Cmd_Unique = str_replace($this->Ini->date_delim . "null" . $this->Ini->date_delim1, "null", $Cmd_Unique) ; 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $Cmd_Unique;
              ...
              if (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_ukey'] . " Email"); 
                  $this->nmgp_opcao = "nada"; 
                  $aUpdateOk[] = 'email';
              }
              $rsUni->Close();
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "cedula = $this->cedula, nombre = '$this->nombre', email = '$this->email', movil = '$this->movil', ciudad = '$this->ciudad', empresa = '$this->empresa'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $this->movil = $this->movil_before_qstr;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['movil'])) { $this->movil = $NM_val_form['movil']; }
              elseif (isset($this->movil)) { $this->nm_limpa_alfa($this->movil); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('cedula', 'nombre', 'email', 'movil', 'ciudad', 'empresa'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          $bInsertOk = true;
          $aInsertOk = array(); 
              $Cmd_Unique = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where cedula = " . $this->cedula . "";
              $Cmd_Unique = str_replace("'null'", "null", $Cmd_Unique) ; 
              $Cmd_Unique = str_replace("#null#", "null", $Cmd_Unique) ; 
              $Cmd_Unique = str_replace($this->Ini->date_delim . "null" . $this->Ini->date_delim1, "null", $Cmd_Unique) ; 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $Cmd_Unique;
              ...
              if (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_inst_uniq'] . " Cedula"); 
                  $this->nmgp_opcao = "nada"; 
                  $GLOBALS["erro_incl"] = 1; 
                  $aInsertOk[] = 'cedula';
              }
              ...
              if (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_inst_uniq'] . " Email"); 
                  $this->nmgp_opcao = "nada"; 
                  $GLOBALS["erro_incl"] = 1; 
                  $aInsertOk[] = 'email';
              }
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (cedula, nombre, email, movil, ciudad, empresa) VALUES ($this->cedula, '$this->nombre', '$this->email', '$this->movil', '$this->ciudad', '$this->empresa')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "cedula, nombre, email, movil, ciudad, empresa) VALUES (" . $NM_seq_auto . "$this->cedula, '$this->nombre', '$this->email', '$this->movil', '$this->ciudad', '$this->empresa')"; 
              }
...
//---------- 
      ...
      { 
          ...
          { 
              $nmgp_select = "SELECT id, cedula, nombre, email, movil, ciudad, empresa from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT id, cedula, nombre, email, movil, ciudad, empresa from " . $this->Ini->nm_tabela ; 
          ...
          { 
              ...
              $this->movil = $rs->fields[4] ; 
              $this->nmgp_dados_select['movil'] = $this->movil;
              $this->ciudad = $rs->fields[5] ; 
              $this->nmgp_dados_select['ciudad'] = $this->ciudad;
              $this->empresa = $rs->fields[6] ; 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['dados_select'];
           $this->SC_log_arr['fields']['cedula']['0'] =  $nmgp_dados_select['cedula'];
           $this->SC_log_arr['fields']['nombre']['0'] =  $nmgp_dados_select['nombre'];
           $this->SC_log_arr['fields']['email']['0'] =  $nmgp_dados_select['email'];
           $this->SC_log_arr['fields']['movil']['0'] =  $nmgp_dados_select['movil'];
           $this->SC_log_arr['fields']['ciudad']['0'] =  $nmgp_dados_select['ciudad'];
           $this->SC_log_arr['fields']['empresa']['0'] =  $nmgp_dados_select['empresa'];
       }
   }
// 
   function NM_gera_log_new() 
   {
       $this->SC_log_arr['fields']['cedula']['1'] =  $this->cedula;
       $this->SC_log_arr['fields']['nombre']['1'] =  $this->nombre;
       $this->SC_log_arr['fields']['email']['1'] =  $this->email;
       $this->SC_log_arr['fields']['movil']['1'] =  $this->movil;
       $this->SC_log_arr['fields']['ciudad']['1'] =  $this->ciudad;
       $this->SC_log_arr['fields']['empresa']['1'] =  $this->empresa;
   }
// 
...
<?php
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "movil", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
