...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cedula
  function do_ajax_form_clientes_mob_validate_cedula()
  {
    var nomeCampo_cedula = "cedula";
    var var_cedula = scAjaxGetFieldText(nomeCampo_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_cedula(var_cedula, var_script_case_init, do_ajax_form_clientes_mob_validate_cedula_cb);
  } // do_ajax_form_clientes_mob_validate_cedula

  function do_ajax_form_clientes_mob_validate_cedula_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_cedula_cb

  // ---------- Validate nombre
  function do_ajax_form_clientes_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_clientes_mob_validate_nombre_cb);
  } // do_ajax_form_clientes_mob_validate_nombre

  function do_ajax_form_clientes_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_nombre_cb
  ...
  // ---------- Validate movil
  function do_ajax_form_clientes_mob_validate_movil()
  {
    var nomeCampo_movil = "movil";
    var var_movil = scAjaxGetFieldText(nomeCampo_movil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_movil(var_movil, var_script_case_init, do_ajax_form_clientes_mob_validate_movil_cb);
  } // do_ajax_form_clientes_mob_validate_movil

  function do_ajax_form_clientes_mob_validate_movil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "movil";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_movil_cb

  // ---------- Validate ciudad
  function do_ajax_form_clientes_mob_validate_ciudad()
  {
    var nomeCampo_ciudad = "ciudad";
    var var_ciudad = scAjaxGetFieldText(nomeCampo_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mob_validate_ciudad(var_ciudad, var_script_case_init, do_ajax_form_clientes_mob_validate_ciudad_cb);
  } // do_ajax_form_clientes_mob_validate_ciudad

  function do_ajax_form_clientes_mob_validate_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciudad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mob_validate_ciudad_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_clientes_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_mob_submit_form(var_cedula, var_nombre, var_email, var_movil, var_ciudad, var_empresa, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clientes_mob_submit_form_cb);
