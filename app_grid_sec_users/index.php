<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_perfil']          = "conexion_mysql";
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'pasaporte_beta2'); 
      } 
      else 
      { 
          ob_start();
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_pasaporte_beta2'])) {
               $_SESSION['scriptcase']['app_grid_sec_users']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pasaporte_beta2'];
           }
       }
   }
