...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "start_date";$Nm_datas[] = "start_time";$Nm_datas[] = "end_date";$Nm_datas[] = "end_time";$Nm_numeric[] = "id";$Nm_numeric[] = "sede_id";$Nm_numeric[] = "cliente_id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_title_cond" name="title_cond" onChange="nm_campos_between(document.getElementById('id_vis_title'), this, 'title')">
      ...
      <br><span id="id_hide_title"  <?php echo $str_hide_title?>><?php
      if ($title != "")
      {
      $title_look = substr($this->Db->qstr($title), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_description_cond" name="description_cond" onChange="nm_campos_between(document.getElementById('id_vis_description'), this, 'description')">
      ...
      <br><span id="id_hide_description"  <?php echo $str_hide_description?>><INPUT  type="text" id="SC_description" name="description" value="<?php echo NM_encode_input($description) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
