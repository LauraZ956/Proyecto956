...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pasaporte_beta2_____grid_calendario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pasaporte_beta2_____grid_calendario"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_calendario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_calendario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_calendario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_calendario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_calendario']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_calendario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_calendario']['embutida_filho'] as $ind => $sc_init)
          {
