...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['inicio']['glo_nm_perfil']         = "conexion_mysql";
    $_SESSION['scriptcase']['inicio']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo']      = "";
...
class inicio_class
{
 ...
 {
    global $inicio_menuData, $nm_data_fixa;
...
$path_libs      = $str_root . $_SESSION['scriptcase']['inicio']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['inicio']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['inicio']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "inicio/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['inicio']['glo_nm_path_imag_temp'];
...
include_once(dirname(__FILE__) . "/inicio_erro.class.php"); 
$this->Erro = new inicio_erro();
$str_path = substr($_SESSION['scriptcase']['inicio']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['inicio']['glo_nm_path_prod'], '/') + 1);
...
$inicio_menuData         = array();
$inicio_menuData['path'] = array();
$inicio_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $inicio_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $inicio_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $inicio_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $inicio_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$inicio_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$inicio_menuData['url']['web']   = str_replace("\\", '/', $inicio_menuData['url']['web']);
$inicio_menuData['path']['root'] = substr($inicio_menuData['path']['sys'],  0, -1 * strlen($inicio_menuData['url']['web']));
$inicio_menuData['path']['app']  = substr($inicio_menuData['path']['sys'],  0, strrpos($inicio_menuData['path']['sys'],  '/'));
$inicio_menuData['path']['link'] = substr($inicio_menuData['path']['app'],  0, strrpos($inicio_menuData['path']['app'],  '/'));
$inicio_menuData['path']['link'] = substr($inicio_menuData['path']['link'], 0, strrpos($inicio_menuData['path']['link'], '/')) . '/';
$inicio_menuData['path']['app'] .= '/';
$inicio_menuData['url']['app']   = substr($inicio_menuData['url']['web'],  0, strrpos($inicio_menuData['url']['web'],  '/'));
$inicio_menuData['url']['link']  = substr($inicio_menuData['url']['app'],  0, strrpos($inicio_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] == "S")
{
    $inicio_menuData['url']['link']  = substr($inicio_menuData['url']['link'], 0, strrpos($inicio_menuData['url']['link'], '/'));
}
$inicio_menuData['url']['link']  .= '/';
$inicio_menuData['url']['app']   .= '/';
...
include_once("inicio_toolbar.php");

$this->tab_grupo[0] = "pasaporte_beta2/";
if ($_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
}

     $_SESSION['scriptcase']['menu_atual'] = "inicio";
     $_SESSION['scriptcase']['menu_apls']['inicio'] = array();
...
{
    $_SESSION['sc_session'][1]['inicio']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['inicio']['init']))
{
    $_SESSION['sc_session'][1]['inicio']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['inicio']['init'];
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_inicio'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_inicio'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_inicio'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['inicio'] = "on";
} 
if (!isset($_SESSION['scriptcase']['inicio']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['inicio']) || $_SESSION['scriptcase']['sc_apl_seg']['inicio'] != "on"))
{ 
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['inicio']['glo_nm_path_prod']);
...
{
    db_conect_devel($_SESSION['scriptcase']['inicio']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['inicio']['glo_nm_path_prod'], 'pasaporte_beta2', 2); 
}
if (isset($_SESSION['scriptcase']['inicio']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['inicio']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['inicio']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['inicio']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['inicio']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['inicio']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['inicio']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['inicio']['sc_outra_jan']) && $_SESSION['sc_session'][1]['inicio']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['inicio']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['inicio']['glo_nm_path_prod'], 'pasaporte_beta2'); 
} 
else 
{ 
...
if (in_array(strtolower($nm_tpbanco), $this->nm_bases_oracle))
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['inicio']['decimal_db'] = ".";
} 
//
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['inicio']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['inicio']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'inicio'))
{
    $_SESSION['sc_session'][1]['inicio']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_inicio'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$inicio_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("calendar_calendario") . "/calendar_calendario_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['calendar_calendario']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("control_sedes_listado") . "/control_sedes_listado_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_sedes_listado']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_sedes") . "/form_sedes_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_sedes']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_calendario") . "/grid_calendario_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_calendario']))
    {
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_inicio'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['calendar_calendario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['calendar_calendario']) == "on")
{
    $inicio_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "|inicio_form_php.php?sc_item_menu=item_1&sc_apl_menu=calendar_calendario&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "|scriptcase__NM__ico__NM__date_time_24.png|" . $this->inicio_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['control_sedes_listado']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_sedes_listado']) == "on")
{
    $inicio_menuData['data'] .= "item_11|.|" . $nm_var_lab[1] . "|inicio_form_php.php?sc_item_menu=item_11&sc_apl_menu=control_sedes_listado&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "|scriptcase__NM__ico__NM__date_time_preferences_24.png|" . $this->inicio_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) == "on")
{
    $inicio_menuData['data'] .= "item_3|.|" . $nm_var_lab[2] . "|inicio_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_clientes&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "|scriptcase__NM__ico__NM__user_24.png|" . $this->inicio_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_sedes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_sedes']) == "on")
{
    $inicio_menuData['data'] .= "item_2|.|" . $nm_var_lab[3] . "|inicio_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_sedes&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "|scriptcase__NM__ico__NM__sc_menu_home_e.png|" . $this->inicio_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_calendario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_calendario']) == "on")
{
    $inicio_menuData['data'] .= "item_4|.|" . $nm_var_lab[4] . "|inicio_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_calendario&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "|scriptcase__NM__ico__NM__document_time_24.png|" . $this->inicio_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_sc_log']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_sc_log']) == "on")
{
    $inicio_menuData['data'] .= "item_23|.|" . $nm_var_lab[5] . "|inicio_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_sc_log&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "|scriptcase__NM__ico__NM__businessman_view_24.png|" . $this->inicio_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $inicio_menuData['data'] .= "item_39|.|" . $nm_var_lab[6] . "|inicio_form_php.php?sc_item_menu=item_39&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "|scriptcase__NM__ico__NM__exit_24.png|" . $this->inicio_target('_parent') . "|" . "\n";
}

$inicio_menuData['data'] .= "item_32|.|" . $nm_var_lab[7] . "||" . $this->Nm_lang['lang_menu_security'] . "|scriptcase__NM__ico__NM__gear_24.png|_self|\n";
...
{
    $inicio_menuData['data'] .= "item_33|..|" . $this->Nm_lang['lang_list_users'] . "|inicio_form_php.php?sc_item_menu=item_33&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->inicio_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) == "on")
{
    $inicio_menuData['data'] .= "item_34|..|" . $this->Nm_lang['lang_list_apps'] . "|inicio_form_php.php?sc_item_menu=item_34&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->inicio_target('_self') . "|" . "\n";
}
...
{
    $inicio_menuData['data'] .= "item_35|..|" . $this->Nm_lang['lang_list_groups'] . "|inicio_form_php.php?sc_item_menu=item_35&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->inicio_target('_self') . "|" . "\n";
}
...
{
    $inicio_menuData['data'] .= "item_42|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|inicio_form_php.php?sc_item_menu=item_42&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->inicio_target('_self') . "|" . "\n";
}
...
{
    $inicio_menuData['data'] .= "item_36|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|inicio_form_php.php?sc_item_menu=item_36&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->inicio_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) == "on")
{
    $inicio_menuData['data'] .= "item_37|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|inicio_form_php.php?sc_item_menu=item_37&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->inicio_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) == "on")
{
    $inicio_menuData['data'] .= "item_40|..|" . $this->Nm_lang['lang_logged_users'] . "|inicio_form_php.php?sc_item_menu=item_40&sc_apl_menu=app_logged_users&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_logged_users'] . "||" . $this->inicio_target('_self') . "|" . "\n";
}


$inicio_menuData['data'] = array();
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_1&sc_apl_menu=calendar_calendario&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['calendar_calendario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['calendar_calendario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "scriptcase__NM__ico__NM__date_time_24.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $inicio_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->inicio_target('_self') . "\"",
        'sc_id'    => "item_1",
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_11&sc_apl_menu=control_sedes_listado&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_sedes_listado']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_sedes_listado']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "scriptcase__NM__ico__NM__date_time_preferences_24.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_clientes&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "scriptcase__NM__ico__NM__user_24.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_sedes&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_sedes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_sedes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "scriptcase__NM__ico__NM__sc_menu_home_e.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_calendario&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_calendario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_calendario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "scriptcase__NM__ico__NM__document_time_24.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($icon_aba) && isset($arr_menuicons['cons']['active']))
    {
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_sc_log&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_sc_log']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_sc_log']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "scriptcase__NM__ico__NM__businessman_view_24.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    if(empty($icon_aba) && isset($arr_menuicons['cons']['active']))
    {
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_39&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "scriptcase__NM__ico__NM__exit_24.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $inicio_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->inicio_target('_parent') . "\"",
        'sc_id'    => "item_39",
        'disabled' => $str_disabled,
        'display'     => "text_img",
        'display_position'=> "text_right",
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "scriptcase__NM__ico__NM__gear_24.png";
$icon_aba = "";
$icon_aba_inactive = "";
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_33&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_34&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_35&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_42&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_36&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_37&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "inicio_form_php.php?sc_item_menu=item_40&sc_apl_menu=app_logged_users&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['inicio']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['inicio']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'inicio');
    $inicio_menuData['data'] = $str_menu_usu;
}
if (is_file("inicio_help.txt"))
{
    $Arq_WebHelp = file("inicio_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $inicio_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->inicio_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['inicio']) && !empty($_SESSION['scriptcase']['sc_menu_del']['inicio']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($inicio_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['inicio']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($inicio_menuData['data'][$i_menu]);
       }
    ...
    $inicio_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['inicio']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['inicio']))
{
    $disable_menu = false;
    foreach ($inicio_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['inicio']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $inicio_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($inicio_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $inicio_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($inicio_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($inicio_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $inicio_menuData['data'][$chave]['level'];
                        unset($inicio_menuData['data'][$chave]);
                }
        }
}
$inicio_menuData['data'] = array_values($inicio_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($inicio_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if (isset($inicio_menuData['data'][$chave + 1]) && !empty($inicio_menuData['data'][$chave + 1]))
            {
                if ($inicio_menuData['data'][$chave]['link'] == "#")
                {
                    if ($inicio_menuData['data'][$chave]['level'] >= $inicio_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($inicio_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($inicio_menuData['data'][$chave]['link'] == "#")
            {
                unset($inicio_menuData['data'][$chave]);
            }
        }
...
/* Cabecera HTML */
if ($inicio_menuData['iframe'])
{
    $inicio_menuData['height'] = '100%';
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['inicio']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/scriptcase_Android_Blue_vert_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "scriptcase_Android_Blue" . '_' . vert . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "scriptcase_Android_Blue" . '_' . vert . '.css'); } ?>" />
<style>
   .scTabText {
   }    <?php
...
{
    $inicio_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['inicio']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['inicio']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['inicio']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="inicio_message.js"></script>
...
{
    if (str_id != "iframe_inicio")
    {
        str_id        = str_id.replace("inicio_","");
    }
    str_link   = $('#' + str_id).attr('item-href');
    str_target = $('#' + str_id).attr('item-target');
    str_id = str_id.replace('iframe_inicio', 'inicio');
    //test link type
    ...
    $('#iframe_inicio')[0].contentWindow.focus();
}
</script>
<?php
...
<?php echo $this->nm_show_toolbarmenu($col_span, $saida_apl, $inicio_menuData, $path_imag_cab); ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
...
echo $this->inicio_escreveMenu($inicio_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Control de iframe */
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['calendar_calendario']) && $_SESSION['scriptcase']['sc_apl_seg']['calendar_calendario'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_inicio');\" item-href=\"inicio_form_php.php?sc_item_menu=inicio&sc_apl_menu=calendar_calendario&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . "\"  item-target=\"inicio_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "inicio_pag_ini.php");
} 
?>
      <iframe id="iframe_inicio" name="inicio_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_inicio').click()";
    echo "</script>";
}
...
/* Control de Target */
function inicio_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
      ...
      <div class='menu__container'>
        ...
        <?php
            ...
            for ($i = 0; $i < sizeof($aMenuItemList); $i++) {
                ...
                ?>
                    <a href="javascript:" onclick="openMenuItem('inicio_<?php echo $aMenuItemList[$i]['id']; ?>');" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>" <?php echo $aMenuItemList[$i]['target']; ?> class='menu__link <?php echo $sDisabledClass; ?>'><?php echo $str_item; ?></a>
                <?php
                if ($hasChildrens) {
                ?>
...
function inicio_target($str_target)
{
    global $inicio_menuData;
    ...
    elseif ($inicio_menuData['iframe'])
    {
        return 'inicio_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $inicio_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "inicio_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "inicio_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['inicio']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->inicio_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['inicio']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
;
 ...
 {
$this->nmgp_redireciona_form($_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . "" . SC_dir_app_name('app_logged') . "/", "inicio_form_php.php", "user?#?" . NM_encode_input($user) . "?@?","_self", 440, 630);
 };
			return false;
		}
$_SESSION['scriptcase']['inicio']['contr_erro'] = 'off';
...
;
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . "" . SC_dir_app_name('app_Login') . "/", "inicio_form_php.php", "","_parent", 440, 630);
 };
		}
if (isset($this->sc_temp_logged_user)) {$_SESSION['logged_user'] = $this->sc_temp_logged_user;}
if (isset($this->sc_temp_logged_date_login)) {$_SESSION['logged_date_login'] = $this->sc_temp_logged_date_login;}
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0)
   {
      ...
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][1]['inicio'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      {
          $nm_apl_dest = str_replace(".php", "", $nm_apl_dest);
          $nm_apl_dest = $inicio_menuData['url']['link'] . $this->tab_grupo[0] .$nm_apl_dest . "/" . $nm_apl_dest . ".php";
      }
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['inicio']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['inicio']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "inicio") {
        ...
        if (isset($_COOKIE['sc_actual_lang_pasaporte_beta2'])) {
            $_SESSION['scriptcase']['inicio']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pasaporte_beta2'];
        }
    }
}
...
$contr_inicio = new inicio_class;
$contr_inicio->inicio_menu();
