...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["inicio"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["inicio"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["inicio"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($inicio_menuData["data"]) && is_array($inicio_menuData["data"]) && !empty($inicio_menuData["data"]))
    {
        foreach($inicio_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($inicio_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
