...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_application_cond" name="application_cond" onChange="nm_campos_between(document.getElementById('id_vis_application'), this, 'application')">
      ...
      <br><span id="id_hide_application"  <?php echo $str_hide_application?>><?php
      if ($application != "")
      {
      $application_look = substr($this->Db->qstr($application), 1, -1); 
      $nmgp_def_dados = array(); 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_id"  <?php echo $str_hide_id?>><INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=8 alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_username_cond" name="username_cond" onChange="nm_campos_between(document.getElementById('id_vis_username'), this, 'username')">
      ...
      <br><span id="id_hide_username"  <?php echo $str_hide_username?>><?php
      if ($username != "")
      {
      $username_look = substr($this->Db->qstr($username), 1, -1); 
      $nmgp_def_dados = array(); 
