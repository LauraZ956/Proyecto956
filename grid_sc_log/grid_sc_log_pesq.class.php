...
class grid_sc_log_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_sc_log_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_sc_log_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_sc_log_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_application')
      {
          $application = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_application($application);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_username')
      {
          $username = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_username($username);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_sc_log/grid_sc_log_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_sc_log_ajax_search.js"></script>
 <script type="text/javascript" src="grid_sc_log_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_sc_log_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sc_log']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_application#NMF#' + search_get_text('SC_application') + '@NMF@';
  str_out += 'id_ac_application#NMF#' + search_get_text('id_ac_application') + '@NMF@';
  ...
  str_out += 'SC_username#NMF#' + search_get_text('SC_username') + '@NMF@';
  str_out += 'id_ac_username#NMF#' + search_get_text('id_ac_username') + '@NMF@';
   ...
   $("#id_ac_username").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_username",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_username").val( $(this).val() );
       }
     }
   });
   $("#id_ac_application").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_application",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_application").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Informe de Auditoría</div>
...
<?php
   ...
   {
      global 
             $application_cond, $application, $application_autocomp,
             $id_cond, $id,
             ...
             $username_cond, $username, $username_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $application = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['application']; 
          $application_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['application_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['id_cond']; 
          $inserted_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_dia']; 
          $inserted_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_mes']; 
          $inserted_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_ano']; 
          $inserted_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_dia']; 
          $inserted_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_mes']; 
          $inserted_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_ano']; 
          $inserted_date_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_hor']; 
          $inserted_date_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_min']; 
          $inserted_date_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_seg']; 
          $inserted_date_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_hor']; 
          $inserted_date_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_min']; 
          $inserted_date_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_seg']; 
          $inserted_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_cond']; 
          $username = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['username']; 
          $username_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['username_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['NM_operador']; 
      ...
      $str_display_inserted_date = ('bw' == $inserted_date_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($application, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $application = substr($application, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['application'])) ? $this->New_label['application'] : "" . $this->Ini->Nm_lang['lang_log_app'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_application_cond" name="application_cond" onChange="nm_campos_between(document.getElementById('id_vis_application'), this, 'application')">
       <OPTION value="qp" <?php if ("qp" == $application_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $application_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $application_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $application_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_application" <?php echo $str_hide_application?> valign="top">
...
<?php
      ...
      {
          $sAutocompValue = $application;
      }
?>
<INPUT  type="text" id="SC_application" name="application" value="<?php echo NM_encode_input($application) ?>"  size=50 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_application" name="application_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=8 alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['inserted_date'])) ? $this->New_label['inserted_date'] : "" . $this->Ini->Nm_lang['lang_log_date_insert'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_inserted_date_cond" name="inserted_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_inserted_date'), this, 'inserted_date')">
       <OPTION value="eq" <?php if ("eq" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_inserted_date" <?php echo $str_hide_inserted_date?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_dia" name="inserted_date_dia" value="<?php echo NM_encode_input($inserted_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_mes" name="inserted_date_mes" value="<?php echo NM_encode_input($inserted_date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_ano" name="inserted_date_ano" value="<?php echo NM_encode_input($inserted_date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_inserted_date_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_hor" name="inserted_date_hor" value="<?php echo NM_encode_input($inserted_date_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_inserted_date_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_min" name="inserted_date_min" value="<?php echo NM_encode_input($inserted_date_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_inserted_date_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_seg" name="inserted_date_seg" value="<?php echo NM_encode_input($inserted_date_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_inserted_date"  <?php echo $str_display_inserted_date; ?> class="scFilterFieldFontOdd">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_input_2_dia" name="inserted_date_input_2_dia" value="<?php echo NM_encode_input($inserted_date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_input_2_mes" name="inserted_date_input_2_mes" value="<?php echo NM_encode_input($inserted_date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_input_2_ano" name="inserted_date_input_2_ano" value="<?php echo NM_encode_input($inserted_date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_inserted_date_input_2_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_input_2_hor" name="inserted_date_input_2_hor" value="<?php echo NM_encode_input($inserted_date_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_inserted_date_input_2_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_input_2_min" name="inserted_date_input_2_min" value="<?php echo NM_encode_input($inserted_date_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_inserted_date_input_2_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_input_2_seg" name="inserted_date_input_2_seg" value="<?php echo NM_encode_input($inserted_date_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['username'])) ? $this->New_label['username'] : "Usuario"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_username_cond" name="username_cond" onChange="nm_campos_between(document.getElementById('id_vis_username'), this, 'username')">
       <OPTION value="qp" <?php if ("qp" == $username_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $username_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $username_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $username_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_username" <?php echo $str_hide_username?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<?php
      ...
      {
          $sAutocompValue = $username;
      }
?>
<INPUT  type="text" id="SC_username" name="username" value="<?php echo NM_encode_input($username) ?>"  size=50 alt="{datatype: 'text', maxLength: 90, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_username" name="username_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 90, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_sc_log_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_sc_log']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_sc_log']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.application_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_application'), document.F1.application_cond, 'application');
   document.F1.application.value = "";
   document.F1.application_autocomp.value = "";
   ...
   document.F1.inserted_date_cond.value = 'eq';
   ...
   document.F1.inserted_date_hor.value = "";
   document.F1.inserted_date_min.value = "";
   document.F1.inserted_date_seg.value = "";
   document.F1.inserted_date_input_2_hor.value = "";
   document.F1.inserted_date_input_2_min.value = "";
   document.F1.inserted_date_input_2_seg.value = "";
   document.F1.username_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_username'), document.F1.username_cond, 'username');
   document.F1.username.value = "";
   document.F1.username_autocomp.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_inserted_date_dia').bind('change', function() {sc_grid_sc_log_valida_dia(this)});
    $('#SC_inserted_date_hor').bind('change', function() {sc_grid_sc_log_valida_hora(this)});
    $('#SC_inserted_date_input_2_dia').bind('change', function() {sc_grid_sc_log_valida_dia(this)});
    $('#SC_inserted_date_input_2_hor').bind('change', function() {sc_grid_sc_log_valida_hora(this)});
    $('#SC_inserted_date_input_2_mes').bind('change', function() {sc_grid_sc_log_valida_mes(this)});
    $('#SC_inserted_date_input_2_min').bind('change', function() {sc_grid_sc_log_valida_min(this)});
    $('#SC_inserted_date_input_2_seg').bind('change', function() {sc_grid_sc_log_valida_seg(this)});
    $('#SC_inserted_date_mes').bind('change', function() {sc_grid_sc_log_valida_mes(this)});
    $('#SC_inserted_date_min').bind('change', function() {sc_grid_sc_log_valida_min(this)});
    $('#SC_inserted_date_seg').bind('change', function() {sc_grid_sc_log_valida_seg(this)});
 }
 function sc_grid_sc_log_valida_dia(obj)
 {
 ...
 function sc_grid_sc_log_valida_mes(obj)
 {
 ...
 function sc_grid_sc_log_valida_hora(obj)
 {
 ...
 function sc_grid_sc_log_valida_min(obj)
 {
 ...
 function sc_grid_sc_log_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "pasaporte_beta2/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
          $NM_patch .= "grid_sc_log/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_application'] = 'text_aut';
      $tp_fields['id_ac_application'] = 'text_aut';
      ...
      $tp_fields['SC_username'] = 'text_aut';
      $tp_fields['id_ac_username'] = 'text_aut';
   ...
   {
      global $application_cond, $application, $application_autocomp,
             $id_cond, $id,
             $inserted_date_cond, $inserted_date, $inserted_date_dia, $inserted_date_mes, $inserted_date_ano, $inserted_date_hor, $inserted_date_min, $inserted_date_seg, $inserted_date_input_2_dia, $inserted_date_input_2_mes, $inserted_date_input_2_ano, $inserted_date_input_2_min, $inserted_date_input_2_hor, $inserted_date_input_2_seg,
             $username_cond, $username, $username_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq'] = array();
      if (!empty($application_autocomp) && empty($application))
      {
          $application = $application_autocomp;
      }
      if (!empty($username_autocomp) && empty($username))
      {
          $username = $username_autocomp;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['application'] = $application; 
      if (is_array($application) && !empty($application))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0] = $application;
      }
      elseif ($application_cond_salva == "nu" || $application_cond_salva == "nn" || $application_cond_salva == "ep" || $application_cond_salva == "ne" ||  !empty($application))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0][0] = $application;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['application_cond'] = $application_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['cmp'] = "application"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['opc'] = $application_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq']['application'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['id'] = $id; 
      if (is_array($id) && !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0] = $id;
      }
      elseif ($id_cond_salva == "nu" || $id_cond_salva == "nn" || $id_cond_salva == "ep" || $id_cond_salva == "ne" ||  !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0][0] = $id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['id_cond'] = $id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['cmp'] = "id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['opc'] = $id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq']['id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_dia'] = $inserted_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_mes'] = $inserted_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_ano'] = $inserted_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_dia'] = $inserted_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_mes'] = $inserted_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_ano'] = $inserted_date_input_2_ano; 
      if (!empty($inserted_date_dia) || !empty($inserted_date_mes) || !empty($inserted_date_ano) || $inserted_date_cond_salva == "nu" || $inserted_date_cond_salva == "nn" || $inserted_date_cond_salva == "ep" || $inserted_date_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $inserted_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $inserted_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $inserted_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $inserted_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $inserted_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $inserted_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_hor'] = $inserted_date_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_min'] = $inserted_date_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_seg'] = $inserted_date_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_hor'] = $inserted_date_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_min'] = $inserted_date_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2_seg'] = $inserted_date_input_2_seg; 
      if (!empty($inserted_date_hor) || !empty($inserted_date_min) || !empty($inserted_date_seg) || $inserted_date_cond_salva == "nu" || $inserted_date_cond_salva == "nn" || $inserted_date_cond_salva == "ep" || $inserted_date_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $inserted_date_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $inserted_date_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $inserted_date_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $inserted_date_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $inserted_date_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $inserted_date_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_cond'] = $inserted_date_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['cmp'] = "inserted_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['opc'] = $inserted_date_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq']['inserted_date'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['username'] = $username; 
      if (is_array($username) && !empty($username))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0] = $username;
      }
      elseif ($username_cond_salva == "nu" || $username_cond_salva == "nn" || $username_cond_salva == "ep" || $username_cond_salva == "ne" ||  !empty($username))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['val'][0][0] = $username;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['username_cond'] = $username_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['cmp'] = "username"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid]['opc'] = $username_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq']['username'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['application'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['application'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['application'] = $application;
      }
      $Conteudo = $id;
      if (strtoupper($id_cond) != "II" && strtoupper($id_cond) != "QP" && strtoupper($id_cond) != "NP" && strtoupper($id_cond) != "IN") 
      { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['username'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['username'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['username'] = $username;
      }

      //----- $application
      $this->Date_part = false;
      if (isset($application) || $application_cond == "nu" || $application_cond == "nn" || $application_cond == "ep" || $application_cond == "ne")
      {
         $this->monta_condicao("application", $application_cond, $application, "", "application");
      }
      ...
      if ($inserted_date_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['inserted_date'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['inserted_date'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($inserted_date_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['inserted_date_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['inserted_date_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['inserted_date_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq']['inserted_date']['label'] = $nmgp_tab_label['inserted_date'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq']['inserted_date']['descr'] = $nmgp_tab_label['inserted_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['grid_pesq']['inserted_date']['hint']  = $nmgp_tab_label['inserted_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $username
      $this->Date_part = false;
      if (isset($username) || $username_cond == "nu" || $username_cond == "nn" || $username_cond == "ep" || $username_cond == "ne")
      {
         $this->monta_condicao("username", $username_cond, $username, "", "username");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['cond_pesq'] .= $this->NM_operador;
