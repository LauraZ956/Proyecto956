<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sc_log']['sc_process_barr'] = true;
require_once('../grid_sc_log/index.php');
unset($_SESSION['scriptcase']['grid_sc_log']['sc_process_barr']);
$ExportCtrl = new grid_sc_log_export_control;
$ExportCtrl->Export_barr();

class grid_sc_log_export_control
{
