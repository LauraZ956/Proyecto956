<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_perfil']          = "conexion_mysql";
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'pasaporte_beta2'); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->Ini->root . $this->Ini->path_prod, 'pasaporte_beta2'); 
      } 
      else 
      { 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_pasaporte_beta2'])) {
               $_SESSION['scriptcase']['app_search_sec_groups']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pasaporte_beta2'];
           }
       }
   }
   if (isset($group)) 
