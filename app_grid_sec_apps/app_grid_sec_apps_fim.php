...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pasaporte_beta2_____app_grid_sec_apps"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pasaporte_beta2_____app_grid_sec_apps"]);
   }
