  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sedes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sedes_form();
	}

  // ---------- Validate linea_
  function do_ajax_form_sedes_validate_linea_(iNumLinha)
  {
    var nomeCampo_linea_ = "linea_" + iNumLinha;
    var var_linea_ = scAjaxGetFieldText(nomeCampo_linea_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sedes_validate_linea_(var_linea_, iNumLinha, var_script_case_init, do_ajax_form_sedes_validate_linea__cb);
  } // do_ajax_form_sedes_validate_linea_

  function do_ajax_form_sedes_validate_linea__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sedes_validate_linea__cb

  // ---------- Validate lote_
  function do_ajax_form_sedes_validate_lote_(iNumLinha)
  {
    var nomeCampo_lote_ = "lote_" + iNumLinha;
    var var_lote_ = scAjaxGetFieldText(nomeCampo_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sedes_validate_lote_(var_lote_, iNumLinha, var_script_case_init, do_ajax_form_sedes_validate_lote__cb);
  } // do_ajax_form_sedes_validate_lote_

  function do_ajax_form_sedes_validate_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sedes_validate_lote__cb

  // ---------- Validate raza_
  function do_ajax_form_sedes_validate_raza_(iNumLinha)
  {
    var nomeCampo_raza_ = "raza_" + iNumLinha;
    var var_raza_ = scAjaxGetFieldText(nomeCampo_raza_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sedes_validate_raza_(var_raza_, iNumLinha, var_script_case_init, do_ajax_form_sedes_validate_raza__cb);
  } // do_ajax_form_sedes_validate_raza_

  function do_ajax_form_sedes_validate_raza__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "raza_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "raza_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sedes_validate_raza__cb

  // ---------- Validate granja_
  function do_ajax_form_sedes_validate_granja_(iNumLinha)
  {
    var nomeCampo_granja_ = "granja_" + iNumLinha;
    var var_granja_ = scAjaxGetFieldText(nomeCampo_granja_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sedes_validate_granja_(var_granja_, iNumLinha, var_script_case_init, do_ajax_form_sedes_validate_granja__cb);
  } // do_ajax_form_sedes_validate_granja_

  function do_ajax_form_sedes_validate_granja__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "granja_" + iLineNumber;
    }
    else
    {
      sFieldValid = "granja_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "granja_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "granja_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sedes_validate_granja__cb

  // ---------- Validate regional_
  function do_ajax_form_sedes_validate_regional_(iNumLinha)
  {
    var nomeCampo_regional_ = "regional_" + iNumLinha;
    var var_regional_ = scAjaxGetFieldText(nomeCampo_regional_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sedes_validate_regional_(var_regional_, iNumLinha, var_script_case_init, do_ajax_form_sedes_validate_regional__cb);
  } // do_ajax_form_sedes_validate_regional_

  function do_ajax_form_sedes_validate_regional__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "regional_" + iLineNumber;
    }
    else
    {
      sFieldValid = "regional_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "regional_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "regional_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sedes_validate_regional__cb

  // ---------- Validate encasetamiento_
  function do_ajax_form_sedes_validate_encasetamiento_(iNumLinha)
  {
    var nomeCampo_encasetamiento_ = "encasetamiento_" + iNumLinha;
    var var_encasetamiento_ = scAjaxGetFieldText(nomeCampo_encasetamiento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sedes_validate_encasetamiento_(var_encasetamiento_, iNumLinha, var_script_case_init, do_ajax_form_sedes_validate_encasetamiento__cb);
  } // do_ajax_form_sedes_validate_encasetamiento_

  function do_ajax_form_sedes_validate_encasetamiento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "encasetamiento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "encasetamiento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "encasetamiento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "encasetamiento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sedes_validate_encasetamiento__cb

  // ---------- Validate observaciones_
  function do_ajax_form_sedes_validate_observaciones_(iNumLinha)
  {
    var nomeCampo_observaciones_ = "observaciones_" + iNumLinha;
    var var_observaciones_ = scAjaxGetFieldText(nomeCampo_observaciones_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sedes_validate_observaciones_(var_observaciones_, iNumLinha, var_script_case_init, do_ajax_form_sedes_validate_observaciones__cb);
  } // do_ajax_form_sedes_validate_observaciones_

  function do_ajax_form_sedes_validate_observaciones__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sedes_validate_observaciones__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sedes_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sedes_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sedes_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sedes_add_new_line_cb);
  } // do_ajax_form_sedes_add_new_line

  function do_ajax_form_sedes_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sedes_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sedes_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sedes_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sedes_backup_line_cb);
  } // do_ajax_form_sedes_backup_line

  function do_ajax_form_sedes_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sedes_backup_line_cb

  function do_ajax_form_sedes_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sedes_cancel_insert

  function do_ajax_form_sedes_cancel_update(iSeqVert)
  {
    do_ajax_form_sedes_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sedes_cancel_update

  function do_ajax_form_sedes_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sedes_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sedes_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_sedes_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sedes_table_refresh_cb);
  } //  do_ajax_form_sedes_table_refresh

  function do_ajax_form_sedes_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_sedes_table_refresh_cb_after_alert);
  } // do_ajax_form_sedes_table_refresh_cb
  function do_ajax_form_sedes_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sedes_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sedes_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sedes_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_raza_ = scAjaxGetFieldText("raza_" + iNumLinha);
    var var_granja_ = scAjaxGetFieldText("granja_" + iNumLinha);
    var var_regional_ = scAjaxGetFieldText("regional_" + iNumLinha);
    var var_encasetamiento_ = scAjaxGetFieldText("encasetamiento_" + iNumLinha);
...
?>
    x_ajax_form_sedes_submit_form(var_linea_, var_lote_, var_raza_, var_granja_, var_regional_, var_encasetamiento_, var_observaciones_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sedes_submit_form_cb);
  } // do_ajax_form_sedes_submit_form

  function do_ajax_form_sedes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("raza_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("granja_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("regional_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("encasetamiento_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sedes_submit_form_cb_after_alert);
  } // do_ajax_form_sedes_submit_form_cb
  function do_ajax_form_sedes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sedes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sedes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sedes_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("raza_" + iNavForm);
      scAjaxHideErrorDisplay("granja_" + iNavForm);
      scAjaxHideErrorDisplay("regional_" + iNavForm);
      scAjaxHideErrorDisplay("encasetamiento_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sedes_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sedes_navigate_form_cb);
  } // do_ajax_form_sedes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sedes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sedes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sedes_navigate_form_cb_after_alert);
  } // do_ajax_form_sedes_navigate_form_cb
  function do_ajax_form_sedes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sedes_navigate_form_cb_after_alert
  function sc_hide_form_sedes_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "raza_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "granja_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "regional_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "encasetamiento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "observaciones_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["linea_" + iNumLinha] = {"label": "Linea<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["raza_" + iNumLinha] = {"label": "Raza<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["granja_" + iNumLinha] = {"label": "Granja<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["regional_" + iNumLinha] = {"label": "Regional<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["encasetamiento_" + iNumLinha] = {"label": "Encasetamiento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["observaciones_" + iNumLinha] = {"label": "Observaciones<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["linea_"][iNumLinha] = "linea_" + iNumLinha;
    ajax_field_mult["lote_"][iNumLinha] = "lote_" + iNumLinha;
    ajax_field_mult["raza_"][iNumLinha] = "raza_" + iNumLinha;
    ajax_field_mult["granja_"][iNumLinha] = "granja_" + iNumLinha;
    ajax_field_mult["regional_"][iNumLinha] = "regional_" + iNumLinha;
    ajax_field_mult["encasetamiento_"][iNumLinha] = "encasetamiento_" + iNumLinha;
    ...
    ajax_field_id["lote_" + iNumLinha] = new Array("hidden_field_label_lote_", "hidden_field_data_lote_" + iNumLinha);
    ajax_field_id["raza_" + iNumLinha] = new Array("hidden_field_label_raza_", "hidden_field_data_raza_" + iNumLinha);
    ajax_field_id["granja_" + iNumLinha] = new Array("hidden_field_label_granja_", "hidden_field_data_granja_" + iNumLinha);
    ajax_field_id["regional_" + iNumLinha] = new Array("hidden_field_label_regional_", "hidden_field_data_regional_" + iNumLinha);
    ajax_field_id["encasetamiento_" + iNumLinha] = new Array("hidden_field_label_encasetamiento_", "hidden_field_data_encasetamiento_" + iNumLinha);
    ...
    ajax_error_count["raza_" + iNumLinha] = "off";
    ajax_error_count["granja_" + iNumLinha] = "off";
    ajax_error_count["regional_" + iNumLinha] = "off";
    ajax_error_count["encasetamiento_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["raza_" + iNumLinha] = "on";
    ajax_read_only["granja_" + iNumLinha] = "on";
    ajax_read_only["regional_" + iNumLinha] = "on";
    ajax_read_only["encasetamiento_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["granja_" + iNumLinha] = "on";
    ajax_read_only["regional_" + iNumLinha] = "on";
    ajax_read_only["encasetamiento_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["raza_" + iNumLinha] = null;
    ajax_error_list["granja_" + iNumLinha] = null;
    ajax_error_list["regional_" + iNumLinha] = null;
    ajax_error_list["encasetamiento_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["raza_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["raza_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["raza_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["raza_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["raza_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["granja_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["granja_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["granja_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["granja_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["granja_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["regional_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["regional_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["regional_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["regional_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["regional_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["encasetamiento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["encasetamiento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["encasetamiento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["encasetamiento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["encasetamiento_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lote_'])) ? $this->nmgp_cmp_readonly['lote_'] : 'on';
?>
    scAjaxFieldRead("lote_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['raza_'])) ? $this->nmgp_cmp_readonly['raza_'] : 'on';
?>
    scAjaxFieldRead("raza_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['granja_'])) ? $this->nmgp_cmp_readonly['granja_'] : 'on';
?>
    scAjaxFieldRead("granja_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['regional_'])) ? $this->nmgp_cmp_readonly['regional_'] : 'on';
?>
    scAjaxFieldRead("regional_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['encasetamiento_'])) ? $this->nmgp_cmp_readonly['encasetamiento_'] : 'off';
?>
    scAjaxFieldRead("encasetamiento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("raza_" + iSeq, "on");
    scAjaxFieldRead("granja_" + iSeq, "on");
    scAjaxFieldRead("regional_" + iSeq, "on");
    scAjaxFieldRead("encasetamiento_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["linea_" + iRow] || "on" == ajax_error_count["lote_" + iRow] || "on" == ajax_error_count["raza_" + iRow] || "on" == ajax_error_count["granja_" + iRow] || "on" == ajax_error_count["regional_" + iRow] || "on" == ajax_error_count["encasetamiento_" + iRow] || "on" == ajax_error_count["observaciones_" + iRow]))
    {
      ...
      $("#hidden_field_data_raza_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_granja_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_regional_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_encasetamiento_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["linea_" + iRow] && "off" == ajax_error_count["lote_" + iRow] && "off" == ajax_error_count["raza_" + iRow] && "off" == ajax_error_count["granja_" + iRow] && "off" == ajax_error_count["regional_" + iRow] && "off" == ajax_error_count["encasetamiento_" + iRow] && "off" == ajax_error_count["observaciones_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["linea_" + iRow] = "off";
        ajax_error_count["lote_" + iRow] = "off";
        ajax_error_count["raza_" + iRow] = "off";
        ajax_error_count["granja_" + iRow] = "off";
        ajax_error_count["regional_" + iRow] = "off";
        ajax_error_count["encasetamiento_" + iRow] = "off";
      ...
      $("#hidden_field_data_raza_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_granja_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_regional_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_encasetamiento_" + iRow).removeClass("scFormErrorLine");
