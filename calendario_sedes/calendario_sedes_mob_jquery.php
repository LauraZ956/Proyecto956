...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_description' + iSeqRow).bind('blur', function() { sc_calendario_sedes_description_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_calendario_sedes_description_onfocus(this, iSeqRow) });
  $('#id_sc_field_start_date' + iSeqRow).bind('blur', function() { sc_calendario_sedes_start_date_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_calendario_sedes_start_date_onfocus(this, iSeqRow) });
  $('#id_sc_field_start_time' + iSeqRow).bind('blur', function() { sc_calendario_sedes_start_time_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_calendario_sedes_start_time_onfocus(this, iSeqRow) });
  $('#id_sc_field_end_date' + iSeqRow).bind('blur', function() { sc_calendario_sedes_end_date_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_calendario_sedes_end_date_onfocus(this, iSeqRow) });
  $('#id_sc_field_end_time' + iSeqRow).bind('blur', function() { sc_calendario_sedes_end_time_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_calendario_sedes_end_time_onfocus(this, iSeqRow) });
  $('#id_sc_field_sede_id' + iSeqRow).bind('blur', function() { sc_calendario_sedes_sede_id_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_calendario_sedes_sede_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliente_id' + iSeqRow).bind('blur', function() { sc_calendario_sedes_cliente_id_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_calendario_sedes_cliente_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_chk_enviar_mail' + iSeqRow).bind('blur', function() { sc_calendario_sedes_chk_enviar_mail_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_calendario_sedes_chk_enviar_mail_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_calendario_sedes_description_onblur(oThis, iSeqRow) {
  do_ajax_calendario_sedes_mob_validate_description();
  scCssBlur(oThis);
}

function sc_calendario_sedes_description_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendario_sedes_start_date_onblur(oThis, iSeqRow) {
  do_ajax_calendario_sedes_mob_validate_start_date();
  scCssBlur(oThis);
}

function sc_calendario_sedes_start_date_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendario_sedes_start_time_onblur(oThis, iSeqRow) {
  do_ajax_calendario_sedes_mob_validate_start_time();
  scCssBlur(oThis);
}

function sc_calendario_sedes_start_time_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendario_sedes_end_date_onblur(oThis, iSeqRow) {
  do_ajax_calendario_sedes_mob_validate_end_date();
  scCssBlur(oThis);
}

function sc_calendario_sedes_end_date_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendario_sedes_end_time_onblur(oThis, iSeqRow) {
  do_ajax_calendario_sedes_mob_validate_end_time();
  scCssBlur(oThis);
}

function sc_calendario_sedes_end_time_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendario_sedes_sede_id_onblur(oThis, iSeqRow) {
  do_ajax_calendario_sedes_mob_validate_sede_id();
  scCssBlur(oThis);
}

function sc_calendario_sedes_sede_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_calendario_sedes_cliente_id_onblur(oThis, iSeqRow) {
  do_ajax_calendario_sedes_mob_validate_cliente_id();
  scCssBlur(oThis);
}

function sc_calendario_sedes_cliente_id_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_calendario_sedes_chk_enviar_mail_onblur(oThis, iSeqRow) {
  do_ajax_calendario_sedes_mob_validate_chk_enviar_mail();
  scCssBlur(oThis);
}

function sc_calendario_sedes_chk_enviar_mail_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_calendario_sedes_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_start_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_calendario_sedes_mob_validate_start_date(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_end_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_calendario_sedes_mob_validate_end_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
