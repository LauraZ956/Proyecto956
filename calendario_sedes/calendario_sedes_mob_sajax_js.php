  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendario_sedes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendario_sedes_mob_form();
	}

  // ---------- Validate sede_id
  function do_ajax_calendario_sedes_mob_validate_sede_id()
  {
    var nomeCampo_sede_id = "sede_id";
    var var_sede_id = scAjaxGetFieldSelect(nomeCampo_sede_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_sedes_mob_validate_sede_id(var_sede_id, var_script_case_init, do_ajax_calendario_sedes_mob_validate_sede_id_cb);
  } // do_ajax_calendario_sedes_mob_validate_sede_id

  function do_ajax_calendario_sedes_mob_validate_sede_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_sedes_mob_validate_sede_id_cb

  // ---------- Validate cliente_id
  function do_ajax_calendario_sedes_mob_validate_cliente_id()
  {
  } // do_ajax_calendario_sedes_mob_validate_cliente_id

  function do_ajax_calendario_sedes_mob_validate_cliente_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_sedes_mob_validate_cliente_id_cb

  // ---------- Validate description
  function do_ajax_calendario_sedes_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_sedes_mob_validate_description(var_description, var_script_case_init, do_ajax_calendario_sedes_mob_validate_description_cb);
  } // do_ajax_calendario_sedes_mob_validate_description

  function do_ajax_calendario_sedes_mob_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_sedes_mob_validate_description_cb

  // ---------- Validate start_date
  function do_ajax_calendario_sedes_mob_validate_start_date()
  {
    ...
    setTimeout(function() {
      var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
      x_ajax_calendario_sedes_mob_validate_start_date(var_start_date, var_script_case_init, do_ajax_calendario_sedes_mob_validate_start_date_cb);
    }, 200);
  } // do_ajax_calendario_sedes_mob_validate_start_date

  function do_ajax_calendario_sedes_mob_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_sedes_mob_validate_start_date_cb

  // ---------- Validate end_date
  function do_ajax_calendario_sedes_mob_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_sedes_mob_validate_end_date(var_end_date, var_script_case_init, do_ajax_calendario_sedes_mob_validate_end_date_cb);
  } // do_ajax_calendario_sedes_mob_validate_end_date

  function do_ajax_calendario_sedes_mob_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_sedes_mob_validate_end_date_cb

  // ---------- Validate start_time
  function do_ajax_calendario_sedes_mob_validate_start_time()
  {
    var nomeCampo_start_time = "start_time";
    var var_start_time = scAjaxGetFieldText(nomeCampo_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_sedes_mob_validate_start_time(var_start_time, var_script_case_init, do_ajax_calendario_sedes_mob_validate_start_time_cb);
  } // do_ajax_calendario_sedes_mob_validate_start_time

  function do_ajax_calendario_sedes_mob_validate_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_sedes_mob_validate_start_time_cb

  // ---------- Validate end_time
  function do_ajax_calendario_sedes_mob_validate_end_time()
  {
    var nomeCampo_end_time = "end_time";
    var var_end_time = scAjaxGetFieldText(nomeCampo_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_sedes_mob_validate_end_time(var_end_time, var_script_case_init, do_ajax_calendario_sedes_mob_validate_end_time_cb);
  } // do_ajax_calendario_sedes_mob_validate_end_time

  function do_ajax_calendario_sedes_mob_validate_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_sedes_mob_validate_end_time_cb

  // ---------- Validate chk_enviar_mail
  function do_ajax_calendario_sedes_mob_validate_chk_enviar_mail()
  {
    var nomeCampo_chk_enviar_mail = "chk_enviar_mail";
    var var_chk_enviar_mail = scAjaxGetFieldCheckbox(nomeCampo_chk_enviar_mail, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendario_sedes_mob_validate_chk_enviar_mail(var_chk_enviar_mail, var_script_case_init, do_ajax_calendario_sedes_mob_validate_chk_enviar_mail_cb);
  } // do_ajax_calendario_sedes_mob_validate_chk_enviar_mail

  function do_ajax_calendario_sedes_mob_validate_chk_enviar_mail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendario_sedes_mob_validate_chk_enviar_mail_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_calendario_sedes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendario_sedes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_calendario_sedes_mob_submit_form(var_sede_id, var_cliente_id, var_description, var_start_date, var_end_date, var_start_time, var_end_time, var_chk_enviar_mail, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendario_sedes_mob_submit_form_cb);
  } // do_ajax_calendario_sedes_mob_submit_form

  function do_ajax_calendario_sedes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    if (!scAjaxHasError())
    {
      document.F6.action = "calendario_sedes_mob_fim.php";
      document.F6.submit();
      return;
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendario_sedes_mob_submit_form_cb_after_alert);
  } // do_ajax_calendario_sedes_mob_submit_form_cb
  function do_ajax_calendario_sedes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendario_sedes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendario_sedes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_calendario_sedes_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendario_sedes_mob_navigate_form_cb);
  } // do_ajax_calendario_sedes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendario_sedes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendario_sedes_mob_navigate_form_cb_after_alert);
  } // do_ajax_calendario_sedes_mob_navigate_form_cb
  function do_ajax_calendario_sedes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendario_sedes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendario_sedes_mob_navigate_form_cb_after_alert
  function sc_hide_calendario_sedes_mob_form()
  {
  ...
  function do_ajax_calendario_sedes_mob_lkpedt_refresh_cliente_id()
  {
    var var_cliente_id = scAjaxGetFieldText("cliente_id");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "cliente_id";
    x_ajax_calendario_sedes_mob_lkpedt_refresh_cliente_id(var_cliente_id, nmgp_refresh_fields, var_script_case_init, do_ajax_calendario_sedes_mob_lkpedt_refresh_cliente_id_cb);
  } // do_ajax_calendario_sedes_mob_lkpedt_refresh_cliente_id

  function do_ajax_calendario_sedes_mob_lkpedt_refresh_cliente_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_calendario_sedes_mob_lkpedt_refresh_cliente_id_cb
  ...
  ajax_field_list[0] = "sede_id";
  ajax_field_list[1] = "cliente_id";
