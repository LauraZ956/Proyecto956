...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("calendario_sedes_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('calendario_sedes_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-cliente_id", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_calendario_sedes_event_cliente_id_onchange) { do_ajax_calendario_sedes_event_cliente_id_onchange(sRow); }
    }
   }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("calendario_sedes_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['calendario_sedes'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['calendario_sedes'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sede_id_label" id="hidden_field_label_sede_id" style="<?php echo $sStyleHidden_sede_id; ?>"><span id="id_label_sede_id"><?php echo $this->nm_new_label['sede_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['php_cmp_required']['sede_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['php_cmp_required']['sede_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cliente_id_label" id="hidden_field_label_cliente_id" style="<?php echo $sStyleHidden_cliente_id; ?>"><span id="id_label_cliente_id"><?php echo $this->nm_new_label['cliente_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['php_cmp_required']['cliente_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['php_cmp_required']['cliente_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
   if (isset($this->Ini->sc_lig_md5["form_clientes"]) && $this->Ini->sc_lig_md5["form_clientes"] == "S") {
       $Parms_Lig  = "nm_evt_ret_edit*scindo_ajax_calendario_sedes_lkpedt_refresh_cliente_id*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@calendario_sedes@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nm_evt_ret_edit*scindo_ajax_calendario_sedes_lkpedt_refresh_cliente_id*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_description_label" id="hidden_field_label_description" style="<?php echo $sStyleHidden_description; ?>"><span id="id_label_description"><?php echo $this->nm_new_label['description']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['php_cmp_required']['description']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['php_cmp_required']['description'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_start_date_label" id="hidden_field_label_start_date" style="<?php echo $sStyleHidden_start_date; ?>"><span id="id_label_start_date"><?php echo $this->nm_new_label['start_date']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['php_cmp_required']['start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['php_cmp_required']['start_date'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['Lookup_chk_enviar_mail'][] = '1'; ?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("calendario_sedes");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("calendario_sedes");
 parent.scAjaxDetailHeight("calendario_sedes", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['calendario_sedes']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
