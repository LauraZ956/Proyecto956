...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['app_logged_users']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['app_logged_users']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['app_logged_users']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['app_logged_users']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['app_logged_users']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['app_logged_users']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['app_logged_users']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
