<?php
@session_start() ;
$_SESSION['scriptcase']['app_logged_users']['sc_process_barr'] = true;
require_once('../app_logged_users/index.php');
unset($_SESSION['scriptcase']['app_logged_users']['sc_process_barr']);
$ExportCtrl = new app_logged_users_export_control;
$ExportCtrl->Export_barr();

class app_logged_users_export_control
{
