<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_logged_users']['glo_nm_perfil']          = "conexion_mysql";
   $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_doc']        = "";
...
// 
      ...
      $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['app_logged_users']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['app_logged_users']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['app_logged_users']['actual_lang']) || $_SESSION['scriptcase']['app_logged_users']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['app_logged_users']['actual_lang'] = $this->str_lang;
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_logged_users']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_logged_users']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['app_logged_users']['session_timeout']['redir']))
      {
...
// 
      ...
      if (isset($_SESSION['scriptcase']['app_logged_users']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['app_logged_users']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['app_logged_users']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['app_logged_users']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['app_logged_users']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['app_logged_users']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_logged_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'pasaporte_beta2'); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_app_logged_users_" . session_id();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['xls_return'] = ($nmgp_opcao == "xls") ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['csv_return'] = ($nmgp_opcao == "csv") ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['xml_return'] = ($nmgp_opcao == "xml") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_app_logged_users_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_app_logged_users_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "xml_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['app_logged_users']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['pdf_det'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['conf_chart_level'] = "N";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['proc_pdf']      = (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] == "pdf_res")) ? true : false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['proc_pdf_vert'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      ...
      { 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['field_order'][] = "sc_session";
          ...
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['usr_cmp_sel']['sc_session'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['usr_cmp_sel'];
      } 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['app_logged_users']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['app_logged_users']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['app_logged_users']['use_pass_pdf'] = "";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "res_print";
          }
      } 
      ...
      { 
          ...
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
...
//
      ...
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['use_pass_pdf']);
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_logged_users/app_logged_users_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_logged_users_xml.class.php"); 
          } 
          $this->xml  = new app_logged_users_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_logged_users/app_logged_users_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_logged_users_csv.class.php"); 
          } 
          $this->csv  = new app_logged_users_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "app_logged_users/app_logged_users_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "app_logged_users_rtf.class.php"); 
          } 
          $this->rtf  = new app_logged_users_rtf();
      ...
      { 
          ...
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['opcao'] = "grid";
              }
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['ajax_nav'])
         {
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['export_sel_columns']['usr_cmp_sel']);
            }
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['pdf_det'])
            {
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['contr_total_geral']  = '';
            // ----- PDF log
...
<?php
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
      {
          ...
          $this->pb->setDir($_SESSION['scriptcase']['app_logged_users']['glo_nm_path_imag_temp'] . "/");
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_logged_users'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['app_logged_users']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['app_logged_users']['sc_process_barr'])) {
       return;
   }
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_logged_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "app_logged_users") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['app_logged_users']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['app_logged_users']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['app_logged_users']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_pasaporte_beta2'])) {
               $_SESSION['scriptcase']['app_logged_users']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pasaporte_beta2'];
           }
       }
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['app_logged_users']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   ...
   if (isset($_SESSION['scriptcase']['app_logged_users']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['app_logged_users']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetAmour/Sc9_SweetAmour";
   ...
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['app_logged_users']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['app_logged_users']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['app_logged_users']['contr_total_geral'] = "NAO";
...
// 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['app_logged_users']['opc_psq'] && !isset($_SESSION['scriptcase']['app_logged_users']['session_timeout']['redir'])) 
       { 
