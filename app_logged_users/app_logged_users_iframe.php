...
if (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_logged_users']['app_logged_users_iframe_params']))
{
    ...
    $str_google_fonts   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_logged_users']['app_logged_users_iframe_params']['str_google_fonts'];
}
...
if (isset($aParams['chart_level'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_logged_users']['chart_level'] = $aParams['chart_level'];
}
elseif (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_logged_users']['chart_level'])) {
    unset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_logged_users']['chart_level']);
}
if (isset($aParams['page_break_pdf']) && $aParams['page_break_pdf'] != "_NO_")
{
    $Arr_page_pdf = explode("_BRK_", $aParams['page_break_pdf']);
    foreach ($_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['Page_break_PDF'] as $cmp => $opt)
    {
        if (in_array($cmp, $Arr_page_pdf))
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['Page_break_PDF'][$cmp] = "S";
        }
        else
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['Page_break_PDF'][$cmp] = "N";
        }
    }
}
$_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['opc_pdf']['all_cab']     = (isset($aParams['pdf_all_cab']))     ? $aParams['pdf_all_cab']     : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['opc_pdf']['all_label']   = (isset($aParams['pdf_all_label']))   ? $aParams['pdf_all_label']   : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['opc_pdf']['label_group'] = (isset($aParams['pdf_label_group'])) ? $aParams['pdf_label_group'] : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['opc_pdf']['pdf_zip']     = (isset($aParams['pdf_zip']))         ? $aParams['pdf_zip']         : "N";
$Nm_lang     = array();
...
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['opc_pdf']['pdf_zip']) && $_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users']['opc_pdf']['pdf_zip'] == "S")
 {
...
$_SESSION['sc_session'][$aParams['script_case_init']]['app_logged_users'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdf_output;
