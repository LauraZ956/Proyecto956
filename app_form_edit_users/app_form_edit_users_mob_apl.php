...
//---------- 
      ...
      { 
          ...
          $rss->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dados_select']['groups'] = str_replace("@?@", ";", $this->groups);
      } 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dados_select']))
       {
           ...
           $this->SC_log_arr['fields']['groups']['0'] =  $nmgp_dados_select['groups'];
       }
   }
// 
   function NM_gera_log_new() 
   {
       ...
       $this->SC_log_arr['fields']['groups']['1'] =  $this->groups;
   }
// 
