  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_calendario_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendar_calendario_mob_form();
	}

  // ---------- Validate cliente_id
  function do_ajax_calendar_calendario_mob_validate_cliente_id()
  {
  } // do_ajax_calendar_calendario_mob_validate_cliente_id

  function do_ajax_calendar_calendario_mob_validate_cliente_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendario_mob_validate_cliente_id_cb

  // ---------- Validate sede_id
  function do_ajax_calendar_calendario_mob_validate_sede_id()
  {
    var nomeCampo_sede_id = "sede_id";
    var var_sede_id = scAjaxGetFieldSelect(nomeCampo_sede_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_calendario_mob_validate_sede_id(var_sede_id, var_script_case_init, do_ajax_calendar_calendario_mob_validate_sede_id_cb);
  } // do_ajax_calendar_calendario_mob_validate_sede_id

  function do_ajax_calendar_calendario_mob_validate_sede_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sede_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendario_mob_validate_sede_id_cb

  // ---------- Validate description
  function do_ajax_calendar_calendario_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_calendario_mob_validate_description(var_description, var_script_case_init, do_ajax_calendar_calendario_mob_validate_description_cb);
  } // do_ajax_calendar_calendario_mob_validate_description

  function do_ajax_calendar_calendario_mob_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendario_mob_validate_description_cb

  // ---------- Validate start_date
  function do_ajax_calendar_calendario_mob_validate_start_date()
  {
    ...
    setTimeout(function() {
      var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
      x_ajax_calendar_calendario_mob_validate_start_date(var_start_date, var_script_case_init, do_ajax_calendar_calendario_mob_validate_start_date_cb);
    }, 200);
  } // do_ajax_calendar_calendario_mob_validate_start_date

  function do_ajax_calendar_calendario_mob_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendario_mob_validate_start_date_cb

  // ---------- Validate end_date
  function do_ajax_calendar_calendario_mob_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_calendario_mob_validate_end_date(var_end_date, var_script_case_init, do_ajax_calendar_calendario_mob_validate_end_date_cb);
  } // do_ajax_calendar_calendario_mob_validate_end_date

  function do_ajax_calendar_calendario_mob_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendario_mob_validate_end_date_cb

  // ---------- Validate start_time
  function do_ajax_calendar_calendario_mob_validate_start_time()
  {
    var nomeCampo_start_time = "start_time";
    var var_start_time = scAjaxGetFieldText(nomeCampo_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_calendario_mob_validate_start_time(var_start_time, var_script_case_init, do_ajax_calendar_calendario_mob_validate_start_time_cb);
  } // do_ajax_calendar_calendario_mob_validate_start_time

  function do_ajax_calendar_calendario_mob_validate_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendario_mob_validate_start_time_cb

  // ---------- Validate end_time
  function do_ajax_calendar_calendario_mob_validate_end_time()
  {
    var nomeCampo_end_time = "end_time";
    var var_end_time = scAjaxGetFieldText(nomeCampo_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_calendario_mob_validate_end_time(var_end_time, var_script_case_init, do_ajax_calendar_calendario_mob_validate_end_time_cb);
  } // do_ajax_calendar_calendario_mob_validate_end_time

  function do_ajax_calendar_calendario_mob_validate_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendario_mob_validate_end_time_cb

  // ---------- Validate chk_enviar_mail
  function do_ajax_calendar_calendario_mob_validate_chk_enviar_mail()
  {
    var nomeCampo_chk_enviar_mail = "chk_enviar_mail";
    var var_chk_enviar_mail = scAjaxGetFieldCheckbox(nomeCampo_chk_enviar_mail, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_calendario_mob_validate_chk_enviar_mail(var_chk_enviar_mail, var_script_case_init, do_ajax_calendar_calendario_mob_validate_chk_enviar_mail_cb);
  } // do_ajax_calendar_calendario_mob_validate_chk_enviar_mail

  function do_ajax_calendar_calendario_mob_validate_chk_enviar_mail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "chk_enviar_mail";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_calendario_mob_validate_chk_enviar_mail_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_calendar_calendario_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_calendario_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cliente_id = scAjaxGetFieldText("cliente_id");
    var var_sede_id = scAjaxGetFieldSelect("sede_id");
    ...
    var var_chk_enviar_mail = scAjaxGetFieldCheckbox("chk_enviar_mail", ";");
    ...
    scAjaxProcOn();
    x_ajax_calendar_calendario_mob_submit_form(var_cliente_id, var_sede_id, var_description, var_start_date, var_end_date, var_start_time, var_end_time, var_chk_enviar_mail, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_calendario_mob_submit_form_cb);
  } // do_ajax_calendar_calendario_mob_submit_form

  function do_ajax_calendar_calendario_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cliente_id");
      scAjaxHideErrorDisplay("sede_id");
      ...
      scAjaxHideErrorDisplay("chk_enviar_mail");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      document.F6.action = "calendar_calendario_mob_fim.php";
      document.F6.submit();
      return;
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_calendario_mob_submit_form_cb_after_alert);
  } // do_ajax_calendar_calendario_mob_submit_form_cb
  function do_ajax_calendar_calendario_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_calendario_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_calendario_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_calendar_calendario_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_calendario_mob_navigate_form_cb);
  } // do_ajax_calendar_calendario_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_calendario_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_calendario_mob_navigate_form_cb_after_alert);
  } // do_ajax_calendar_calendario_mob_navigate_form_cb
  function do_ajax_calendar_calendario_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_calendario_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_calendario_mob_navigate_form_cb_after_alert
  function sc_hide_calendar_calendario_mob_form()
  {
  ...
  function do_ajax_calendar_calendario_mob_lkpedt_refresh_cliente_id()
  {
    var var_cliente_id = scAjaxGetFieldText("cliente_id");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "cliente_id";
    x_ajax_calendar_calendario_mob_lkpedt_refresh_cliente_id(var_cliente_id, nmgp_refresh_fields, var_script_case_init, do_ajax_calendar_calendario_mob_lkpedt_refresh_cliente_id_cb);
  } // do_ajax_calendar_calendario_mob_lkpedt_refresh_cliente_id

  function do_ajax_calendar_calendario_mob_lkpedt_refresh_cliente_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_calendar_calendario_mob_lkpedt_refresh_cliente_id_cb
  ...
  ajax_field_list[0] = "cliente_id";
  ajax_field_list[1] = "sede_id";
  ajax_field_list[2] = "description";
  ajax_field_list[3] = "start_date";
  ajax_field_list[4] = "end_date";
  ajax_field_list[5] = "start_time";
  ajax_field_list[6] = "end_time";
  ajax_field_list[7] = "chk_enviar_mail";
  ...
  var ajax_error_list = {
    "cliente_id": {"label": "Cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sede_id": {"label": "Sede", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "end_time": {"label": "Hora final", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "chk_enviar_mail": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "end_time": new Array(),
    "chk_enviar_mail": new Array()
  };
  ajax_field_mult["cliente_id"][1] = "cliente_id";
  ajax_field_mult["sede_id"][1] = "sede_id";
  ...
  ajax_field_mult["chk_enviar_mail"][1] = "chk_enviar_mail";

  var ajax_field_id = {
    "cliente_id": new Array("hidden_field_label_cliente_id", "hidden_field_data_cliente_id"),
    "sede_id": new Array("hidden_field_label_sede_id", "hidden_field_data_sede_id"),
    ...
    "chk_enviar_mail": new Array("hidden_field_label_chk_enviar_mail", "hidden_field_data_chk_enviar_mail")
  };
