<?php
//
class calendar_calendario_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      {
          if (isset($this->NM_ajax_info['param']['chk_enviar_mail']))
          {
              $this->chk_enviar_mail = $this->NM_ajax_info['param']['chk_enviar_mail'];
          }
          if (isset($this->NM_ajax_info['param']['cliente_id']))
          {
              $this->cliente_id = $this->NM_ajax_info['param']['cliente_id'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['sede_id']))
          {
              $this->sede_id = $this->NM_ajax_info['param']['sede_id'];
          }
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_calendar_calendario_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_calendario_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['calendar_calendario_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_calendario_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_calendario_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_calendario_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_calendario_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_calendario_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_calendario_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " calendario";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "calendar_calendario_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_calendario_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_calendario_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_calendario_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_calendario_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_calendario_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dados_form'];
          if (!isset($this->id)){$this->id = $this->nmgp_dados_form['id'];} 
          if (!isset($this->title)){$this->title = $this->nmgp_dados_form['title'];} 
          if (!isset($this->recurrence)){$this->recurrence = $this->nmgp_dados_form['recurrence'];} 
          if (!isset($this->period)){$this->period = $this->nmgp_dados_form['period'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("calendar_calendario_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'calendar_calendario/calendar_calendario_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'calendar_calendario_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'calendar_calendario_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_calendario_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'calendar_calendario/calendar_calendario_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_calendario_mob_erro.class.php"); 
      }
      $this->Erro      = new calendar_calendario_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_calendario_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      if (isset($this->sede_id)) { $this->nm_limpa_alfa($this->sede_id); }
      if (isset($this->cliente_id)) { $this->nm_limpa_alfa($this->cliente_id); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- cliente_id
      $this->field_config['cliente_id']               = array();
      $this->field_config['cliente_id']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['cliente_id']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['cliente_id']['symbol_dec'] = '';
      $this->field_config['cliente_id']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['cliente_id']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- start_date
      ...
      $this->field_config['start_time']['date_display'] = "hhii";
      ...
      $this->field_config['end_time']['date_display'] = "hhii";
...
//
      ...
      {
          if ('validate_cliente_id' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'cliente_id');
          }
          if ('validate_sede_id' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'sede_id');
          }
          ...
          if ('validate_chk_enviar_mail' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'chk_enviar_mail');
          }
          calendar_calendario_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'autocomp_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          if ('autocomp_cliente_id' == $this->NM_ajax_opcao)
          {
              if (isset($_GET['term'])) {
                  $this->cliente_id = ($_SESSION['scriptcase']['charset'] != "UTF-8") ? NM_utf8_decode(sc_convert_encoding($_GET['term'], $_SESSION['scriptcase']['charset'], 'UTF-8')) : $_GET['term'];
              } else {
                  $this->cliente_id = '';
              }
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_cliente_id']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_cliente_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_cliente_id']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_cliente_id'] = array(); 
    }
   ...
   $nm_comando = "SELECT cedula, nombre FROM clientes WHERE nombre LIKE '%" . substr($this->Db->qstr($this->cliente_id), 1, -1) . "%' ORDER BY nombre";
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(calendar_calendario_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', calendar_calendario_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_cliente_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          if (is_array($this->chk_enviar_mail))
          {
              ...
              if ($this->chk_enviar_mail_1 != "") 
              { 
                  foreach ($this->chk_enviar_mail_1 as $dados_chk_enviar_mail_1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->chk_enviar_mail .= ";";
                      } 
                      $this->chk_enviar_mail .= $dados_chk_enviar_mail_1;
                      $x++ ; 
                  } 
              } 
          } 
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['calendar_calendario_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "calendar_calendario_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " calendario") ?></TITLE>
...
<form name="Fdown" method="get" action="calendar_calendario_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="calendar_calendario_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="calendar_calendario_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'calendar_calendario_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'calendar_calendario_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'calendar_calendario_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_calendario_mob']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_calendario_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_calendario_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_calendario_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['bypass_required_time']['start_time'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['bypass_required_time']['end_time'] = true;
      }
      if ('' == $filtro || 'cliente_id' == $filtro)
        $this->ValidateField_cliente_id($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "cliente_id";

      if ('' == $filtro || 'sede_id' == $filtro)
        $this->ValidateField_sede_id($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "sede_id";
      ...
      if ('' == $filtro || 'chk_enviar_mail' == $filtro)
        $this->ValidateField_chk_enviar_mail($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "chk_enviar_mail";

      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['bypass_required_time']['start_time'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['bypass_required_time']['end_time'] = false;
...
//---
      ...
      {
      $_SESSION['scriptcase']['calendar_calendario_mob']['contr_erro'] = 'on';
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_cliente_id = $this->cliente_id;
    $original_sede_id = $this->sede_id;
}
  
$cad="";
$sql = "SELECT nombre FROM clientes WHERE cedula = $this->cliente_id ";
...
$sql = "SELECT granja FROM sedes WHERE id = $this->sede_id ";
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_cliente_id != $this->cliente_id || (isset($bFlagRead_cliente_id) && $bFlagRead_cliente_id)))
    {
        $this->ajax_return_values_cliente_id(true);
    }
    if (($original_sede_id != $this->sede_id || (isset($bFlagRead_sede_id) && $bFlagRead_sede_id)))
    {
        $this->ajax_return_values_sede_id(true);
    }
}
$_SESSION['scriptcase']['calendar_calendario_mob']['contr_erro'] = 'off'; 
      }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_chk_enviar_mail = $this->chk_enviar_mail;
}
  if ($this->chk_enviar_mail ==1){
	$this->enviar_recordatorio();
}

if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_chk_enviar_mail != $this->chk_enviar_mail || (isset($bFlagRead_chk_enviar_mail) && $bFlagRead_chk_enviar_mail)))
    {
        $this->ajax_return_values_chk_enviar_mail(true);
    }
}
$_SESSION['scriptcase']['calendar_calendario_mob']['contr_erro'] = 'off'; 
          }
    ...
    function ValidateField_cliente_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      nm_limpa_numero($this->cliente_id, $this->field_config['cliente_id']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->cliente_id != '')  
          { 
              $iTestSize = 11;
              if (strlen($this->cliente_id) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Cliente: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['cliente_id']))
                  {
                      $Campos_Erros['cliente_id'] = array();
                  }
                  $Campos_Erros['cliente_id'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['cliente_id']) || !is_array($this->NM_ajax_info['errList']['cliente_id']))
                  {
                      $this->NM_ajax_info['errList']['cliente_id'] = array();
                  }
                  $this->NM_ajax_info['errList']['cliente_id'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->cliente_id, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Cliente; " ; 
                  if (!isset($Campos_Erros['cliente_id']))
                  ...
                  $Campos_Erros['cliente_id'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['cliente_id']) || !is_array($this->NM_ajax_info['errList']['cliente_id']))
                  {
                      $this->NM_ajax_info['errList']['cliente_id'] = array();
                  }
                  $this->NM_ajax_info['errList']['cliente_id'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['php_cmp_required']['cliente_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['php_cmp_required']['cliente_id'] == "on") 
           { 
              $hasError = true;
              ...
              $Campos_Erros['cliente_id'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['cliente_id']) || !is_array($this->NM_ajax_info['errList']['cliente_id']))
                  {
                      $this->NM_ajax_info['errList']['cliente_id'] = array();
                  }
                  $this->NM_ajax_info['errList']['cliente_id'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    } // ValidateField_cliente_id

    function ValidateField_sede_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->sede_id == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['php_cmp_required']['sede_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['php_cmp_required']['sede_id'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "Sede" ; 
          if (!isset($Campos_Erros['sede_id']))
          {
              $Campos_Erros['sede_id'] = array();
          }
          $Campos_Erros['sede_id'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          if (!isset($this->NM_ajax_info['errList']['sede_id']) || !is_array($this->NM_ajax_info['errList']['sede_id']))
          {
              $this->NM_ajax_info['errList']['sede_id'] = array();
          }
          $this->NM_ajax_info['errList']['sede_id'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->sede_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_sede_id']) && !in_array($this->sede_id, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_sede_id']))
          {
              $hasError = true;
              ...
              $Campos_Erros['sede_id'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($this->NM_ajax_info['errList']['sede_id']) || !is_array($this->NM_ajax_info['errList']['sede_id']))
              {
                  $this->NM_ajax_info['errList']['sede_id'] = array();
              }
              $this->NM_ajax_info['errList']['sede_id'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
          }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'sede_id';
    ...
    } // ValidateField_sede_id

    function ValidateField_description(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['php_cmp_required']['description']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['php_cmp_required']['description'] == "on")) 
      { 
          if ($this->description == "")  
          { 
              $hasError = true;
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_calendar_fld_description'] . "" ; 
    ...
    function ValidateField_start_date(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['php_cmp_required']['start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['php_cmp_required']['start_date'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_chk_enviar_mail(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->chk_enviar_mail == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
      else 
      { 
          if (is_array($this->chk_enviar_mail))
          {
              ...
              foreach ($this->chk_enviar_mail as $ind => $dados_chk_enviar_mail_1 ) 
              {
                  if ($dados_chk_enviar_mail_1 != "") 
                  {
                      $this->chk_enviar_mail_1[] = $dados_chk_enviar_mail_1;
                  } 
              } 
              $this->chk_enviar_mail = ""; 
              foreach ($this->chk_enviar_mail_1 as $dados_chk_enviar_mail_1 ) 
        ...
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'chk_enviar_mail';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_chk_enviar_mail
   ...
   function nm_guardar_campos()
   {
    global
           $sc_seq_vert;
    $this->nmgp_dados_form['cliente_id'] = $this->cliente_id;
    $this->nmgp_dados_form['sede_id'] = $this->sede_id;
    ...
    $this->nmgp_dados_form['chk_enviar_mail'] = $this->chk_enviar_mail;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['cliente_id'] = $this->cliente_id;
      nm_limpa_numero($this->cliente_id, $this->field_config['cliente_id']['symbol_grp']) ; 
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ('' !== $this->cliente_id || (!empty($format_fields) && isset($format_fields['cliente_id'])))
      {
          nmgp_Form_Num_Val($this->cliente_id, $this->field_config['cliente_id']['symbol_grp'], $this->field_config['cliente_id']['symbol_dec'], "0", "S", $this->field_config['cliente_id']['format_neg'], "", "", "-", $this->field_config['cliente_id']['symbol_fmt']) ; 
      }
...
//-- 
   ...
   {
          $this->ajax_return_values_cliente_id();
          $this->ajax_return_values_sede_id();
          ...
          $this->ajax_return_values_chk_enviar_mail();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = calendar_calendario_mob_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values

          //----- cliente_id
   function ajax_return_values_cliente_id($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cliente_id", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cliente_id);
              $aLookup = array();
              $this->_tmp_lookup_cliente_id = $this->cliente_id;
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cliente_id'] = array(
                       'row'    => '',
               'type'    => 'text',
          ...
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['cliente_id']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['cliente_id']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['cliente_id']['labList'] = $aLabel;
          $val_output = isset($aLookup[0][calendar_calendario_mob_pack_protect_string(NM_charset_to_utf8($unformatted_value_cliente_id))]) ? $aLookup[0][calendar_calendario_mob_pack_protect_string(NM_charset_to_utf8($unformatted_value_cliente_id))] : "";
          $this->NM_ajax_info['fldList']['cliente_id_autocomp'] = array(
               'type'    => 'text',
          ...
          //----- sede_id
   function ajax_return_values_sede_id($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("sede_id", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->sede_id);
              $aLookup = array();
              $this->_tmp_lookup_sede_id = $this->sede_id;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_sede_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_sede_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_sede_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_sede_id'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_sede_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"sede_id\"";
          if (isset($this->NM_ajax_info['select_html']['sede_id']) && !empty($this->NM_ajax_info['select_html']['sede_id']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['sede_id'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->sede_id == $sValue)
                  {
                      $this->_tmp_lookup_sede_id = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['sede_id'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['sede_id']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['sede_id']['valList'][$i] = calendar_calendario_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['sede_id']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['sede_id']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['sede_id']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_end_time($bForce = false)
   {
          ...
          //----- chk_enviar_mail
   function ajax_return_values_chk_enviar_mail($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("chk_enviar_mail", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->chk_enviar_mail);
              $aLookup = array();
              $this->_tmp_lookup_chk_enviar_mail = $this->chk_enviar_mail;

$aLookup[] = array(calendar_calendario_mob_pack_protect_string('1') => calendar_calendario_mob_pack_protect_string("Enviar turno por email"));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['Lookup_chk_enviar_mail'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['chk_enviar_mail']) && !empty($this->NM_ajax_info['select_html']['chk_enviar_mail']))
          {
              $sOptComp = $this->NM_ajax_info['select_html']['chk_enviar_mail'];
          }
          $this->NM_ajax_info['fldList']['chk_enviar_mail'] = array(
                       'row'    => '',
               'type'    => 'checkbox',
               'switch'  => false,
               ...
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-chk_enviar_mail',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['chk_enviar_mail']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['chk_enviar_mail']['valList'][$i] = calendar_calendario_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['chk_enviar_mail']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['chk_enviar_mail']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['chk_enviar_mail']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opcao'] = '';
   ...
   { 
      ...
      $NM_val_form['cliente_id'] = $this->cliente_id;
      $NM_val_form['sede_id'] = $this->sede_id;
      ...
      $NM_val_form['chk_enviar_mail'] = $this->chk_enviar_mail;
      ...
      if ($this->sede_id === "" || is_null($this->sede_id))  
      { 
          $this->sede_id = 0;
          $this->sc_force_zero[] = 'sede_id';
      } 
      if ($this->cliente_id === "" || is_null($this->cliente_id))  
      { 
          $this->cliente_id = 0;
          $this->sc_force_zero[] = 'cliente_id';
      } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "description = '$this->description', start_date = #$this->start_date#, start_time = #$this->start_time#, end_date = #$this->end_date#, end_time = #$this->end_time#, sede_id = $this->sede_id, cliente_id = $this->cliente_id"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "description = '$this->description', start_date = " . $this->Ini->date_delim . $this->start_date . $this->Ini->date_delim1 . ", start_time = " . $this->Ini->date_delim . $this->start_time . $this->Ini->date_delim1 . ", end_date = " . $this->Ini->date_delim . $this->end_date . $this->Ini->date_delim1 . ", end_time = " . $this->Ini->date_delim . $this->end_time . $this->Ini->date_delim1 . ", sede_id = $this->sede_id, cliente_id = $this->cliente_id"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "description = '$this->description', start_date = EXTEND('$this->start_date', YEAR TO DAY), start_time = " . $this->Ini->date_delim . $this->start_time . $this->Ini->date_delim1 . ", end_date = EXTEND('$this->end_date', YEAR TO DAY), end_time = " . $this->Ini->date_delim . $this->end_time . $this->Ini->date_delim1 . ", sede_id = $this->sede_id, cliente_id = $this->cliente_id"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['recurrence']) && $NM_val_form['recurrence'] != $this->nmgp_dados_select['recurrence']) 
              { 
                  $SC_fields_update[] = "recurrence = '$this->recurrence'"; 
              } 
              if (isset($NM_val_form['period']) && $NM_val_form['period'] != $this->nmgp_dados_select['period']) 
              { 
                  $SC_fields_update[] = "period = '$this->period'"; 
              } 
              $aDoNotUpdate = array();
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['db_changed'] = true;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['sede_id'])) { $this->sede_id = $NM_val_form['sede_id']; }
              elseif (isset($this->sede_id)) { $this->nm_limpa_alfa($this->sede_id); }
              if     (isset($NM_val_form) && isset($NM_val_form['cliente_id'])) { $this->cliente_id = $NM_val_form['cliente_id']; }
              elseif (isset($this->cliente_id)) { $this->nm_limpa_alfa($this->cliente_id); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('cliente_id', 'sede_id', 'description', 'start_date', 'end_date', 'start_time', 'end_time', 'chk_enviar_mail'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (title, description, start_date, start_time, end_date, end_time, recurrence, period, sede_id, cliente_id) VALUES ('$this->title', '$this->description', #$this->start_date#, #$this->start_time#, #$this->end_date#, #$this->end_time#, '$this->recurrence', '$this->period', $this->sede_id, $this->cliente_id)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "title, description, start_date, start_time, end_date, end_time, recurrence, period, sede_id, cliente_id) VALUES (" . $NM_seq_auto . "'$this->title', '$this->description', " . $this->Ini->date_delim . $this->start_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->start_time . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->end_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->end_time . $this->Ini->date_delim1 . ", '$this->recurrence', '$this->period', $this->sede_id, $this->cliente_id)"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "title, description, start_date, start_time, end_date, end_time, recurrence, period, sede_id, cliente_id) VALUES (" . $NM_seq_auto . "'$this->title', '$this->description', EXTEND('$this->start_date', YEAR TO DAY), " . $this->Ini->date_delim . $this->start_time . $this->Ini->date_delim1 . ", EXTEND('$this->end_date', YEAR TO DAY), " . $this->Ini->date_delim . $this->end_time . $this->Ini->date_delim1 . ", '$this->recurrence', '$this->period', $this->sede_id, $this->cliente_id)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "title, description, start_date, start_time, end_date, end_time, recurrence, period, sede_id, cliente_id) VALUES (" . $NM_seq_auto . "'$this->title', '$this->description', " . $this->Ini->date_delim . $this->start_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->start_time . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->end_date . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->end_time . $this->Ini->date_delim1 . ", '$this->recurrence', '$this->period', $this->sede_id, $this->cliente_id)"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
          { 
              $nmgp_select = "SELECT id, title, description, str_replace (convert(char(10),start_date,102), '.', '-') + ' ' + convert(char(8),start_date,20), str_replace (convert(char(10),start_time,102), '.', '-') + ' ' + convert(char(8),start_time,20), str_replace (convert(char(10),end_date,102), '.', '-') + ' ' + convert(char(8),end_date,20), str_replace (convert(char(10),end_time,102), '.', '-') + ' ' + convert(char(8),end_time,20), recurrence, period, sede_id, cliente_id from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT id, title, description, convert(char(23),start_date,121), convert(char(23),start_time,121), convert(char(23),end_date,121), convert(char(23),end_time,121), recurrence, period, sede_id, cliente_id from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT id, title, description, start_date, start_time, end_date, end_time, recurrence, period, sede_id, cliente_id from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT id, title, description, EXTEND(start_date, YEAR TO DAY), start_time, EXTEND(end_date, YEAR TO DAY), end_time, recurrence, period, sede_id, cliente_id from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT id, title, description, start_date, start_time, end_date, end_time, recurrence, period, sede_id, cliente_id from " . $this->Ini->nm_tabela ; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->sede_id = $rs->fields[9] ; 
              $this->nmgp_dados_select['sede_id'] = $this->sede_id;
              $this->cliente_id = $rs->fields[10] ; 
              $this->nmgp_dados_select['cliente_id'] = $this->cliente_id;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dados_select'] = $this->nmgp_dados_select;
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dados_select'];
           $this->SC_log_arr['fields']['title']['0'] =  $nmgp_dados_select['title'];
           $this->SC_log_arr['fields']['description']['0'] =  $nmgp_dados_select['description'];
           $this->SC_log_arr['fields']['start_date']['0'] =  $nmgp_dados_select['start_date'];
           $this->SC_log_arr['fields']['start_time']['0'] =  $nmgp_dados_select['start_time'];
           $this->SC_log_arr['fields']['end_date']['0'] =  $nmgp_dados_select['end_date'];
           $this->SC_log_arr['fields']['end_time']['0'] =  $nmgp_dados_select['end_time'];
           $this->SC_log_arr['fields']['recurrence']['0'] =  $nmgp_dados_select['recurrence'];
           $this->SC_log_arr['fields']['period']['0'] =  $nmgp_dados_select['period'];
           $this->SC_log_arr['fields']['sede_id']['0'] =  $nmgp_dados_select['sede_id'];
           $this->SC_log_arr['fields']['cliente_id']['0'] =  $nmgp_dados_select['cliente_id'];
       }
   }
// 
   function NM_gera_log_new() 
   {
       ...
       $this->SC_log_arr['fields']['start_date']['1'] =  $this->start_date;
       $this->SC_log_arr['fields']['start_time']['1'] =  $this->start_time;
       $this->SC_log_arr['fields']['end_date']['1'] =  $this->end_date;
       $this->SC_log_arr['fields']['end_time']['1'] =  $this->end_time;
       $this->SC_log_arr['fields']['recurrence']['1'] =  $this->recurrence;
       $this->SC_log_arr['fields']['period']['1'] =  $this->period;
       $this->SC_log_arr['fields']['sede_id']['1'] =  $this->sede_id;
       $this->SC_log_arr['fields']['cliente_id']['1'] =  $this->cliente_id;
   }
// 
   ...
   function NM_gera_log_output() 
   {
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }

//
function enviar_email($p_destinatario, $p_asunto, $p_mensaje){
$_SESSION['scriptcase']['calendar_calendario_mob']['contr_erro'] = 'on';
  	


	$mail_smtp_server 		= 'smtp.gmail.com';       					
	$mail_smtp_user   		= 'micorreo@gmail.com';                		
	$mail_smtp_pass   		= 'MiContra$ena';                						
	$mail_from        		= 'MI EMPRESA PASS<micorreo@gmail.com>';		
	$mail_to          		= $p_destinatario;         							
	$mail_subject     		= $p_asunto;            							
	$mail_message     		= $p_mensaje; 										
	$mail_format      		= 'H';                       						
	$mail_copies         	= 'copiaoculta@example.com';                        	
	$mail_tp_copies      	= 'BCC';                        					
	$mail_port           	= '25';                     						
	$mail_tp_connection  	= 'N';                       						
	$mail_attachments 		= array(                     						
							'../tickets/imprimir-20200812-RPH04-0001.pdf'
							);
...
;
	...
	if ($this->sc_mail_ok ){
		echo "Mensaje enviado a <b>$p_destinatario</b> correctamente<br>";
	}else{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_calendar_calendario_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['calendar_calendario_mob']['contr_erro'] = 'on';
	...
	$sql = "SELECT email, nombre FROM clientes WHERE cedula = $this->cliente_id ";
...
;
	if( !empty($this->ds ) ) {$destinatario_email = $this->ds[0][1]."<".$this->ds[0][0].">";}
...
;
	if( !empty($this->ds ) ) {$sede_nombre = $this->ds[0][0];}
	
	$asunto = "Recordatorio de su visita a la sede $sede_nombre";
	
	$mensaje = "<h2>Pasaporte Mi Empresa</h2>";
	$mensaje = "Recuerde que tiene una cita el próximo:<br>";
	
	setlocale(LC_TIME, "es_ES"); 
	$dia = strftime('%A', strtotime( $this->start_date  ));

	$mensaje .= "<b>$dia, ".$this->nm_conv_data_db($this->start_date , "db_format", "dd/mm/aaaa")." a las ".substr($this->start_time ,0,5)."</b><br>";

	$mensaje .= "En la sede: <b>$sede_nombre</b><br><br>";
	$mensaje .= "En caso de anulación o cambio de fecha, por favor comuníquese a la línea <b>(2) 4852711</b>";
	
	$this->enviar_email ($destinatario_email,$asunto,$mensaje);
$_SESSION['scriptcase']['calendar_calendario_mob']['contr_erro'] = 'off';
}
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    $this->start_date_Dt_min = date('Ymd'); 
    $this->end_date_Dt_min = date('Ymd'); 
        $this->initFormPages();
    ...
    include_once("calendar_calendario_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['sc_outra_jan'] != 'calendar_calendario_mob')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
@media (max-width: 853px) {
 ...
 <script type="text/javascript">
  ...
  function calendar_print() {
      $.ajax({
          url: 'calendar_calendario_mob.php',
          type: 'GET',
          dataType: 'json',
          data: {
...
?>
      events: 'calendar_calendario_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
{
?>
        tb_show('', 'calendar_calendario_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
{
?>
        tb_show('', 'calendar_calendario_mob.php?nmgp_opcao=igual_calendar&id=' + calEvent.id + '&__orig_id=' + calEvent.id + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
  ...
  function scEditEvent(sEventId) {
    ...
    $("#sc-ui-form").submit();
        ...
        function refreshFilterCategories() {
                $('#calendar').fullCalendar('removeEventSource', 'calendar_calendario_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));

                setCategory();

                $('#calendar').fullCalendar('addEventSource', 'calendar_calendario_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
        }
...
<form name="F1" id="sc-ui-form" method="post"
      action="calendar_calendario.php"
      target="_self">
...
<?php
                ...
                if ($addEvent) {
                    ...
                    if (empty($params['daysToAdd'])) {
                        if ($params['displayStartDate'] <= $thisStartDate) {
                            $newEvent = $thisEvent;
                            $this->calendarTimestampToStart($newEvent, $this->calendarGetMktime($thisStartDate, $params['startTime']));
                            if ($params['forceEndToStart']) {
                                $this->calendarTimestampToEnd($newEvent, $this->calendarGetMktime($thisStartDate, $params['endTime']));
                            }
                            else {
                                $this->calendarTimestampToEnd($newEvent, $this->calendarGetMktime($thisEndDate, $params['endTime']));
                            }
                        ...
                        foreach ($params['daysToAdd'] as $newDay) {
                            ...
                            if ($params['displayEndDate'] > $newDate && $newDate <= $params['endDate']) {
                                if ($params['displayStartDate'] <= $newDate) {
                                    $newEvent = $thisEvent;
                                    $this->calendarTimestampToStart($newEvent, $this->calendarGetMktime($newDate, $params['startTime']));
                                    $this->calendarTimestampToEnd($newEvent, $this->calendarGetMktime($newDate, $params['endTime']));
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_chk_enviar_mail()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "Enviar turno por email?#?1?#??@?";
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['empty_filter']);
      ...
      $sv_data = $data_search;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_calendar_calendario_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['total'] = $qt_geral_reg_calendar_calendario_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          calendar_calendario_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "calendar_calendario_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_calendario_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_calendario_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
