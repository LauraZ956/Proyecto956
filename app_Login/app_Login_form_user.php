...
<html lang="en">
	<head>
		...
		<title>Mi Empresa PASS | Inicio de Sesión</title>
...
<input type="hidden" name="csrf_token" value="<?php echo $this->scCsrfGetToken() ?>" />
                      ...
                      <input type="text" id="inputEmail" class="form-control  sc-js-input "  name="login" id="id_sc_field_login" value="<?php echo $this->form_encode_input($login) ?>"  alt="{datatype: 'text', maxLength: 200, allowedChars: '<?php echo $this->allowedCharsCharset("abcdefghijklmnopqrstuvwxyz0123456789.") ?>', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"  placeholder="Usuario*" required autofocus>
                      <input type="password" id="inputPassword" class="form-control  sc-js-input "  name="pswd" id="id_sc_field_pswd" value="<?php echo $this->form_encode_input($pswd) ?>"  alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"  placeholder="Contraseña*" required>
						* <?php echo $this->Ini->Nm_lang['lang_othr_reqr']; ?>
						<!--SC_CAPTCHA-->
                      <input class="my-3 btn btn-lg btn-primary btn-block btn-signin" type="button" value="INGRESAR"  onclick="nm_atualiza('alterar');"  />
