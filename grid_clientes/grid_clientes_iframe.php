...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_clientes']['opc_pdf']['all_cab']     = (isset($aParams['pdf_all_cab']))     ? $aParams['pdf_all_cab']     : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_clientes']['opc_pdf']['all_label']   = (isset($aParams['pdf_all_label']))   ? $aParams['pdf_all_label']   : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_clientes']['opc_pdf']['label_group'] = (isset($aParams['pdf_label_group'])) ? $aParams['pdf_label_group'] : "N";
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_clientes_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_clientes']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_clientes']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_clientes.pdf';
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_clientes'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdf_output;
