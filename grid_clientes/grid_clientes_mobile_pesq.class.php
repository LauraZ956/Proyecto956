...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "cedula";$Nm_numeric[] = "id";$Nm_numeric[] = "cedula";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cedula_cond" name="cedula_cond" onChange="nm_campos_between(document.getElementById('id_vis_cedula'), this, 'cedula')">
      ...
      <br><span id="id_hide_cedula"  <?php echo $str_hide_cedula?>><INPUT  type="text" id="SC_cedula" name="cedula" value="<?php echo NM_encode_input($cedula) ?>" size=50 alt="{datatype: 'integer', maxLength: 100, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
