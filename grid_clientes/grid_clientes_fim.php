...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pasaporte_beta2_____grid_clientes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pasaporte_beta2_____grid_clientes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_clientes'] = array();
   $fecha_janela = false;
