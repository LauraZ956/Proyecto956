<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_clientes']['glo_nm_perfil']          = "conexion_mysql";
...
// 
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_clientes']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_clientes']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_clientes']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_clientes']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_clientes']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_clientes']['opcao'] = $_GET['origem'];
...
<?php
      ...
      $this->sc_lig_target["A_@scinf__@scinf_form_clientes"] = '';
      ...
      $this->link_form_clientes =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_clientes') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_clientes']['glo_nm_conexao'], $this->root . $this->path_prod, 'pasaporte_beta2'); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_clientes']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_clientes']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " clientes";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['SC_All_Groupby'] = array('sc_free_total' => 'grid');
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "cedula";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "nombre";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "email";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "movil";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "ciudad";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "empresa";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['field_order'][] = "id";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['usr_cmp_sel']['id'] = "off";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['orig_pesq'] = 'res';
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
...
//
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_grid_clientes.pdf";
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['grid_pesq']);
               continue;
           }
           ...
           {
               $busca[$dats[0]] = $dats[1];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
               if (isset($fields[$ix]['vls'][1]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "grid_clientes_pesq.class.php"); 
   ...
   {
      if (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['grid_pesq'][$cmp_del]);
   }
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_imag_temp'] . "/sc_apl_default_pasaporte_beta2.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_pasaporte_beta2'])) {
               $_SESSION['scriptcase']['grid_clientes']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pasaporte_beta2'];
           }
       }
   }
   ...
   if (isset($_SESSION['scriptcase']['grid_clientes']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_clientes']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetAmour/Sc9_SweetAmour";
...
// 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['grid_clientes']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_clientes']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_clientes'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_clientes']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_clientes']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_clientes']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_clientes']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_clientes']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
?>
